...
const atlasSections = [
  ...
  },
  {
    ...
    title: "План навчання",
    description:
      "Вісім модулів ведуть від перевірки актуального тексту права до самостійного аналізу повного комплекту матеріалів справи. Кожен модуль має завдання, результат і критерії перевірки.",
