...
import { ShellIntersections } from "~/components/layout/shell-intersections"
...
export default function Home() {
  ...
  return (
    <main className="atlas-shell container-wrapper px-2 pb-6">
      <div className="home-atlas px-6 sm:px-10 lg:px-16">
          ...
          <div className="home-hero-grid">
            <div className="home-intro">
              ...
              <p className="mt-7 max-w-md text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">
                Поняття, документи та хід справи. Пояснення для тих, хто працює
                з легалізацією іноземців у Польщі.
              </p>
        ...
        <ShellIntersections bottom edgesOnly />
      </div>
    </main>
  )
}
