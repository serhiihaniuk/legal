...
export const documentGuides: readonly DocumentGuide[] = [
  {
    ...
    purpose: [
      ...
      "Дає органу структуровані дані для перевірки умов art. 114 ustawy o cudzoziemcach.",
    ],
    doesNotProve: [
    ...
    legalBasis: [
      "Art. 106 ust. 2, art. 106d, art. 114 і art. 118 ustawy o cudzoziemcach.",
      "§ 2 ust. 2 і załącznik nr 2 do rozporządzenia Dz.U. 2026 poz. 553.",
    ],
    keyChecks: [
  ...
  },
  {
    ...
    purpose: [
      ...
      "Дозволяє зіставити фактичну роботу з Załącznikiem nr 1, powiadomieniem або дозволом.",
    ],
    doesNotProve: [
    ...
    legalBasis: [
      ...
      "Art. 5 ustawy z 20.03.2025 o warunkach dopuszczalności powierzania pracy cudzoziemcom.",
      "У справі pobyt czasowy i pracę — art. 114 ustawy o cudzoziemcach.",
    ],
    keyChecks: [
      "Сторони, підписант, вид договору, посада, місце, час, винагорода і дата початку.",
      "Відповідність Załącznikowi nr 1 та фактичній організації праці.",
  ...
  },
  {
    ...
    legalBasis: [
      "Art. 105–107 і art. 106c–106l ustawy o cudzoziemcach.",
      "Форма та технічні вимоги — Dz.U. 2026 poz. 553.",
    ],
    keyChecks: [
      "Правильний вид дозволу та дані, тотожні паспорту.",
      "Відповідність договору, Załącznika nr 1 та інших додатків.",
  ...
  },
  {
    ...
    legalBasis: [
      "Art. 106e ustawy o cudzoziemcach.",
      "§ 6 rozporządzenia Dz.U. 2026 poz. 553.",
    ],
    keyChecks: [
  ...
  },
  {
    ...
    legalBasis: [
      "Art. 50–56 KPA.",
      "Art. 64 § 2 KPA — усунення формальних недоліків.",
      "У справах pobytowych також спеціальні art. 106e, 106f і 106i ustawy o cudzoziemcach.",
    ],
    keyChecks: [
  ...
  },
  {
    ...
    legalBasis: [
      "Art. 104–113 KPA та спеціальні норми ustawy o cudzoziemcach.",
    ],
    keyChecks: [
  ...
  },
  {
    ...
    legalBasis: [
      "Вимога залежить від матеріальної умови конкретної процедури; у pobyt czasowy i pracę перевіряйте art. 114 ust. 1 pkt 1 ustawy o cudzoziemcach.",
  ...
  },
  {
    ...
    relatedDocuments: ["Karta pobytu", "Dowód opłaty skarbowej za zezwolenie"],
  ...
  },
  {
    ...
    legalBasis: [
      ...
      "Для договору з cudzoziemcem — art. 5 ustawy z 20.03.2025 o warunkach dopuszczalności powierzania pracy cudzoziemcom.",
    ],
    keyChecks: [
