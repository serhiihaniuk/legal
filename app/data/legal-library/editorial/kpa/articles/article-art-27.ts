  ...
  entries: [
    {
      ...
      legalEffect:
        "Колегіальне рішення має приймати склад без осіб, щодо яких є визначена законом підстава виключення. Попередня участь має значення у випадках, указаних у цих нормах. Якщо через виключення орган не може діяти, застосовують передбачений статтею механізм заміни.",
      foreignersCase:
