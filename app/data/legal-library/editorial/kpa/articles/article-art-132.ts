  ...
  entries: [
    {
      ...
      legalEffect:
        "За цих умов перша інстанція може скасувати рішення повністю або частково й у цьому обсязі вирішити справу по суті, або скасувати рішення й припинити провадження повністю чи частково.",
      foreignersCase:
