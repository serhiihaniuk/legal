  ...
  entries: [
    {
      ...
      summary: kpaLaw.text`Стаття зобов'язує компетентний орган тимчасово зупинити виконання рішення, якщо є ймовірність однієї з вад, названих в ${kpaLaw.article("156", "art. 156 § 1")}. Це запобіжний захід на час перевірки nieważności.`,
      rules: [
        {
          locator: "§ 1",
          explanation: kpaLaw.text`Компетентний орган з власної ініціативи або на вимогу сторони зупиняє виконання, коли є ймовірність однієї з вад, перелічених у ${kpaLaw.article("156", "art. 156 § 1")}.`,
        },
        {
          locator: "§ 2",
          explanation:
