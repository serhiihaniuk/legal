  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 1 pkt 5–8",
          explanation:
            "Також підставами є виявлені істотні факти або докази, які існували на день видання рішення й були невідомі органу, що його видав; відсутність обов'язкової позиції іншого органу; інше вирішення попереднього питання (zagadnienie wstępne) чи подальше скасування або зміна адміністративного або судового акта, на якому ґрунтувалося рішення (decyzja).",
        },
        {
          locator: "§ 2–3",
          explanation:
