  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 3–4",
          explanation:
            "Орган, до якого звернулися по позицію, надає її невідкладно, не пізніше двох тижнів від вручення йому вимоги, якщо норма права не встановлює іншого строку. За потреби він може провести власне з’ясування.",
        },
        {
          locator: "§ 5–6",
          explanation:
