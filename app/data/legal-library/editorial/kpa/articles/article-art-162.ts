  ...
  entries: [
    {
      ...
      legalEffect:
        "Орган окремим рішенням установлює wygaśnięcie або скасовує первинне рішення, називаючи відповідну підставу. Вимога такої форми не встановлює єдиної дати припинення дії для всіх цих випадків.",
