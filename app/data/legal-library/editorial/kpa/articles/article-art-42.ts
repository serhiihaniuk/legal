  ...
  entries: [
    {
      ...
      rules: [
        ...
        {
          locator: "§ 2–3",
          explanation: kpaLaw.text`Лист можна вручити у приміщенні органу, якщо спеціальні приписи не встановлюють іншого. За неможливості способів із ${kpaLaw.article("42", "§ 1–2")} або за необхідної потреби вручають у будь-якому місці, де застануть адресата.`,
        },
      ],
      legalEffect:
