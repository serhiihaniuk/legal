  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 4–5",
          explanation:
            "Починаючи справу іншої особи, орган повідомляє громадську організацію, якщо вважає, що вона може бути зацікавлена в участі через свої статутні цілі й за це промовляє суспільний інтерес. Організація, яка не бере участі на правах сторони, може за згодою органу подати свій погляд, виражений в ухвалі або заяві її статутного органу.",
        },
      ],
      legalEffect:
