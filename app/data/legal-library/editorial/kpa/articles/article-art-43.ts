  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "zd. 2",
          explanation:
            "Про вручення сусідові або dozorcy адресата повідомляють, залишаючи повідомлення в його поштовій скриньці. Лише якщо це неможливо, повідомлення розміщують на дверях житла.",
        },
      ],
      legalEffect:
        "За виконання передумов лист вважається врученим адресату через іншу особу.",
