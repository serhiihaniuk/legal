  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 1a–2",
          explanation:
            "Wezwanie містить належну інформацію RODO. Її можна не повторювати, лише якщо адресат уже має ці відомості, а їхній обсяг і зміст не змінилися. Письмо також має містити підпис працівника з ім’ям, прізвищем та посадою.",
        },
      ],
      legalEffect:
