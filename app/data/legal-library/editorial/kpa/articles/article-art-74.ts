  ...
  entries: [
    {
      ...
      summary:
        "Стаття обмежує доступ до матеріалів із позначенням tajne або ściśle tajne та до матеріалів, виключених органом через важливий державний інтерес, і встановлює форму відмови.",
      rules: [
        {
          locator: "§ 1",
