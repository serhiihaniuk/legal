  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 2",
          explanation:
            "Окреме podanie, внесене відповідно до повідомлення протягом чотирнадцяти днів від його вручення, вважається поданим у день первинного podania.",
        },
        {
          locator: "§ 3–4",
          explanation:
      ...
      legalEffect:
        "Орган розглядає свою частину вимог, а заявник окремо подає решту до відповідних органів. Первинна дата зберігається для окремого podanie, поданого відповідно до повідомлення протягом чотирнадцяти днів від його вручення.",
      foreignersCase:
