  ...
  entries: [
    {
      ...
      rules: [
        ...
        },
        {
          locator: "§ 3–4",
          explanation:
            "Додатки до паперового рішення за згодою сторони, висловленою письмово або усно до протоколу, можна вручити на іншому trwałym nośniku informacji. Носій має дозволяти зберігати інформацію протягом потрібного часу так, щоб унеможливити її зміну або відтворити її у версії та формі, у яких її створили чи передали.",
        },
      ],
      legalEffect:
