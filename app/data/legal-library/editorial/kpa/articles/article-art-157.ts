  ...
  entries: [
    {
      ...
      summary:
        "Стаття визначає орган і спосіб початку провадження щодо nieważności decyzji. Зазвичай справу веде орган вищого ступеня, а провадження може початися на вимогу сторони або з власної ініціативи органу.",
      rules: [
        {
          locator: "§ 1",
          explanation:
