  ...
  entries: [
    {
      ...
      rules: [
        {
          locator: "єдиний блок",
          explanation: kpaLaw.text`Для відповідного застосування глав 12 і 13 розділу II KPA закон приймає, що наслідок видання остаточної decyzji настав у строк чотирнадцяти днів від спливу строку, про який ідеться в ${kpaLaw.article("122c", "art. 122c § 1")}. Це окреме правило для названих способів перегляду, а не заміна дати самого мовчазного вирішення.`,
        },
      ],
      legalEffect:
