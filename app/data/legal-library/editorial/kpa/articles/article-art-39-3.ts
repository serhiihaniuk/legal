  ...
  entries: [
    {
      ...
      foreignersCase: kpaLaw.text`У справі іноземця відсутність рукописного підпису на wydruku не робить письмо автоматично недійсним, якщо виконані вимоги ${kpaLaw.article("39-3", "art. 39³")}.`,
    },
  ],
})
