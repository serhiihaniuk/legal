...
export const foreignersActPart13a1 = defineEditorialPart<
  ...
  entries: [
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 452 ust. 1–2 передбачає надання даних з krajowy zbiór rejestrów, ewidencji i wykazu w sprawach cudzoziemców суб’єктам з Art. 450 ust. 1–2 на підставі wniosek на formularzu; орган відмовляє decyzja, якщо запитаний zakres даних не відповідає межам Art. 450 ust. 1–2. Ust. 3 визначає органи, які надають дані, а ust. 4 делегує міністру визначення wzór formularza.",
          sourceLocator: "Art. 452 ust. 1–4",
        },
      ],
      summary:
        "Стаття встановлює формальний шлях доступу до даних реєстрів cudzoziemców для суб’єктів, уже названих у Art. 450, і розподіляє компетенцію між органами.",
      rules: [
        {
          locator: "ust. 1–2",
          explanation:
            "Wniosek подається на formularzu. Якщо zakres даних у заяві не відповідає дозволеному zakres за Art. 450 ust. 1–2, орган відмовляє у наданні даних у формі decyzja.",
        },
        {
          locator: "ust. 3",
          explanation:
      ...
      legalEffect:
        "Art. 452 регулює процедуру і компетенцію доступу до даних, але не розширює коло суб’єктів або zakres даних, визначені Art. 450. Відмова через невідповідний zakres оформлюється decyzja.",
      foreignersCase:
        "У справі звірте, чи заявник належить до суб’єктів Art. 450, який саме zakres даних просить, на якому formularz подано wniosek і який орган веде відповідний реєстр; не вважайте сам статус cudzoziemca підставою для доступу.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 453 передбачає надання даних через urządzenia telekomunikacyjne уповноваженим суб’єктам після jednorazowy wniosek і згоди Szef Urzędu, якщо виконані сукупні умови щодо захищених urządzenia або systemy, технічних та організаційних zabezpieczenia і обґрунтованості такого способу завданнями або діяльністю. Ust. 2–3 регулюють спільний wniosek та oświadczenia суб’єктів.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 454 встановлює письмове powiadomienie Szef Urzędu про zgoda на надання даних через urządzenia telekomunikacyjne та її zakres; odmowa zgody або cofnięcie zgody відбуваються у формі decyzja. Для wniosek за Art. 453 ust. 2 повідомлення та рішення адресуються podmiot składający wniosek із зазначенням або охопленням відповідних суб’єктів, а decyzja про cofnięcie підлягає natychmiastowemu wykonaniu.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Про zgoda та zakres udostępnienia Szef Urzędu повідомляє podmiot з Art. 450 письмово. Відмова у згоді або її cofnięcie оформлюються decyzja.",
        },
        {
          locator: "ust. 1a–1b",
          explanation:
            "Якщо wniosek подано за Art. 453 ust. 2, про zgoda повідомляють podmiot składający wniosek із переліком усіх суб’єктів, яким надаються дані; decyzja про odmowa doręczaється цьому заявнику.",
        },
        {
          locator: "ust. 1c–2",
          explanation:
      ...
      legalEffect:
        "Стаття визначає форму комунікації та процесуальний наслідок odmowa або cofnięcie zgody, але не замінює умови доступу з Art. 453. Негайне виконання прямо встановлено лише для decyzja про cofnięcie згода.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 455 дозволяє Szef Urzędu контролювати суб’єктів, які мають доступ до даних через urządzenia telekomunikacyjne або systemy teleinformatyczne, щодо виконання умов Art. 453 ust. 1. Kontrola може відбуватися в siedziba та місцях і часі виконання завдань, а уповноважений працівник Urzędu діє на підставі imienne upoważnienie і після пред’явлення dowód osobisty; контрольований суб’єкт має надати документи, urządzenia або systemy та умови для контролю.",
      ...
      rules: [
        {
          locator: "ust. 1–3",
          explanation:
            "Szef Urzędu може перевіряти виконання умов Art. 453 ust. 1. Kontrola проводиться у siedziba, місцях і часі виконання завдань, а за потреби — також у вихідні та поза робочими годинами; її проводить уповноважений imiennie працівник після пред’явлення dowód osobisty.",
        },
        {
      ...
      legalEffect:
        "Art. 455 створює контрольний механізм щодо умов Art. 453, але сам по собі не встановлює, що конкретний суб’єкт порушив правила. Факти контролю мають бути підтверджені upoważnienie, матеріалами та protokół.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 456 дозволяє Szef Urzędu заблокувати доступ до krajowy zbiór rejestrów, ewidencji i wykazu w sprawach cudzoziemców до усунення nieprawidłowości, якщо в роботі або zabezpieczeniaх zbioru виявлено порушення, що виникли з вини органів, які мають доступ через urządzenia telekomunikacyjne або systemy teleinformatyczne.",
      ...
      legalEffect:
        "Це захід захисту системи та даних, прив’язаний до конкретних встановлених недоліків і вини органу. Art. 456 не визначає наперед тривалість блокування понад час, потрібний для усунення nieprawidłowości.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 457 зобов’язує ministra właściwego do spraw wewnętrznych визначити в drodze rozporządzenia спосіб і tryb kontroli доступу до даних через urządzenia telekomunikacyjne або systemy teleinformatyczne, wzór upoważnienia з Art. 455 ust. 3 та wzór protokołu з Art. 455 ust. 5 pkt 2; у розпорядженні мають бути враховані захист danych osobowych і безпека даних.",
      ...
      legalEffect:
        "Art. 457 є нормою про делегування до rozporządzenie і форми контрольних документів. Він сам не встановлює конкретну процедуру перевірки поза межами делегованих питань і не доводить наявність порушення.",
      foreignersCase:
        "У справі про kontrola звірте фактичні дії з чинним розporządzenie, wzór upoważnienie та protokół, на які посилається Art. 455; окремо перевірте, як враховано безпеку обробки даних.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 458 зобов’язує ministra właściwego do spraw wewnętrznych визначити в drodze rozporządzenia порядок надання, зміни та cofanie uprawnień доступу до krajowy zbiór, технічні умови доступу, wzory upoważnienie, wniosków про zgoda за звичайним і спільним режимом Art. 453 ust. 2 та oświadczenie з Art. 453 ust. 3; розпорядження має враховувати безпеку, sprawność операцій і czytelność даних та інформації для Szef Urzędu.",
      ...
      rules: [
        ...
        },
        {
          ...
          explanation:
            "Окремо визначаються wzory wniosek про згоду на доступ через urządzenia telekomunikacyjne, wniosek у режимі Art. 453 ust. 2 та oświadczenie суб’єкта з Art. 453 ust. 3.",
        },
        {
          locator: "Art. 458",
          explanation:
      ...
      legalEffect:
        "Норма деталізує зміст майбутнього або чинного rozporządzenie, але не замінює індивідуальну zgoda Szef Urzędu чи умови Art. 453. Наявність wzór formularza сама по собі не створює права на доступ.",
      foreignersCase:
    ...
    },
    {
      ...
      legalEffect:
        "Art. 459 встановлює обов’язок przewoźnik щодо необхідних документів, але сама стаття не визначає результат контролю конкретної особи й не замінює окремі правила про odmowa wjazdu або відповідальність.",
      foreignersCase:
