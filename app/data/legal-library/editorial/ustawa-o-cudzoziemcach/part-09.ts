...
export const foreignersActPart09 = defineEditorialPart<
...
>({
  ...
  entries: [
    ...
    },
    {
      ...
      foreignersCase:
        "Негайно зафіксуйте дату вручення postanowienie, зміст протоколу і факт подання заżalenie; саме подання не означає, що виконання зупинено.",
    },
    {
    ...
    },
    {
      ...
      summary:
        "Art. 311 — uchylony; у наведеній редакції стаття скасована.",
      rules: [
        {
          locator: "Art. 311",
          explanation:
    ...
    },
    {
      ...
      summary:
        "Art. 313 — uchylony; у наведеній редакції стаття скасована.",
      rules: [
        {
          locator: "Art. 313",
          explanation:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 4–5",
          explanation:
            "Стаття розподіляє виконання між комendant Straży Granicznej і вимагає записати дату залишення Польщі в реєстрі.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "Таке рішення підлягає негайному примусовому виконанню.",
        },
      ],
      legalEffect:
