...
export const foreignersActPart11 = defineEditorialPart<
...
>({
  ...
  entries: [
    ...
    },
    {
      ...
      foreignersCase:
        "Складіть checklist за кожним релевантним посиланням із art. 360–379 та 394–427 і перевірте, яка саме дія здійснюється щодо іноземця.",
    },
    {
