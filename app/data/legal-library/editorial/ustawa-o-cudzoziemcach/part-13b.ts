...
export const foreignersActPart13b = defineEditorialPart<
  ...
  entries: [
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 465 ust. 1 передбачає karę grzywny, зокрема за pobyt без tytuł prawny, невиконання вимоги показати документи або кошти, невиконання обов’язку залишити Польщу та окремі порушення малого ruchu granicznego; ust. 1a передбачає grzywna 200–2000 zł за невиконання обов’язку з Art. 157a ust. 2.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 1a–3",
          explanation:
            "За Art. 157a ust. 2 передбачена grzywna від 200 до 2000 zł; orzekanie відбувається за Kodeks postępowania w sprawach o wykroczenia, а wyrok nakazowy є natychmiast wykonalny.",
        },
      ],
      legalEffect:
      ...
      foreignersCase:
        "Порівняйте протокол або матеріали справи з конкретним pkt Art. 465: встановіть tytuł pobytowy, отриману вимогу, строк і доказ вручення; окремо перевірте порядок оскарження за правилами про wykroczenia.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 465a регулює дії після orzeczenie zastępczej kary aresztu за окремі wykroczenia з Art. 465: dyrektor zakładu karnego повідомляє орган Straży Granicznej, а суд після отримання decyzja про zobowiązaniu do powrotu umarza postępowanie wykonawcze та видає nakaz zwolnienia.",
      ...
      legalEffect:
        "Норма описує наслідки саме тієї комбінації обставин, яку називає Art. 465a. Вона не скасовує саму decyzja o zobowiązaniu do powrotu і не поширюється автоматично на інші покарання чи провадження.",
      foreignersCase:
        "Звірте, за яким пунктом Art. 465 призначено zastępcza kara aresztu, копію decyzja o powrocie, повідомлення zakład karny та ухвалу суду про zwolnienie.",
    },
    {
      ...
      foreignersCase:
        "Для старого дозволу встановіть його вид, дату видачі, строк чинності та дату wejścia w życie ustawy; у висновку вкажіть, як саме Art. 507 змінює назву статусу.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 508 регулює перетворення старих decyzje: рішення про zgoda na pobyt tolerowany у названих випадках стають рішеннями про zgoda na pobyt ze względów humanitarnych або про zgoda na pobyt tolerowany за Art. 351, а decyzje o zobowiązaniu do opuszczenia та o wydaleniu стають decyzjami o zobowiązaniu do powrotu.",
      ...
      rules: [
        {
          locator: "ust. 1–2",
          explanation:
            "Класифікація старої decyzja залежить від конкретної przesłanka старого Art. 97 або Art. 141 ust. 2; рішення про opuszczenie або wydalenie, за винятком названого в тексті випадку, стають рішеннями про powrót.",
        },
        {
          locator: "ust. 3–6",
          explanation:
      ...
      legalEffect:
        "Наслідок залежить від виду старого рішення, його правової підстави та перехідної дати. Art. 508 не дозволяє змінювати категорію документа без перевірки конкретної przesłanka.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 509 визначає, які попередні періоди pobytu за starymi tytułami зараховуються до періоду, потрібного для окремих нових дозволів: zezwolenie na zamieszkanie на час означений, згода humanitarna та окремі випадки ochrony uzupełniającej.",
      ...
      foreignersCase:
        "Складіть хронологію всіх tytuł pobytowy, назвіть правову підставу кожного періоду та окремо перевірте, чи відповідає вона конкретному пункту Art. 509.",
    },
    {
      ...
      foreignersCase:
        "Звірте вид документа, стару правову підставу, дату видачі та кінцеву дату; не замінюйте перевірку чинності самим посиланням на Art. 510.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 511 дозволяє до wyczerpania zapasów, але не довше одного року від wejścia w życie ustawy, видавати blankiety старих zaproszenia та документів за wzory зі старих aktów wykonawczych.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 512 передбачає застосування dotychczasowe przepisy до строку opuszczenia Польщі та допомоги в dobrowolny powrót, якщо до wejścia w życie ustawy вже було видано рішення про відмову в статусі uchodźcy, ochronie uzupełniającej або zgoda na pobyt tolerowany.",
      ...
      legalEffect:
        "Наслідок залежить від дати та виду попереднього рішення. Посилання на Art. 512 саме по собі не визначає чинний строк виїзду без перевірки decyzja і правил, що діяли тоді.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 513 ust. 1 встановлює, що незавершені до wejścia w życie ustawy адміністративні провадження без ostateczna decyzja, розпочаті на підставі названих старих законів, продовжуються за dotychczasowe przepisy.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 514 передбачає, що в окремих рішеннях, які завершують старі незакінчені провадження, не виноситься рішення про zobowiązanie do opuszczenia або wydalenie; органи повідомляють właściwy organ Straży Granicznej після набрання рішенням ostateczność.",
      ...
      legalEffect:
        "Наслідок обмежений старими провадженнями та прямо названими видами рішень. Art. 514 не означає, що в сучасному провадженні ніколи не може бути рішення про powrót.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 515 перетворює незавершені до wejścia w życie ustawy провадження щодо wymiana karty pobytu, виданої у зв’язку зі старою zgoda na pobyt tolerowany, на провадження про wydanie або wymiana документа «zgoda na pobyt tolerowany»; wojewoda і Szef Urzędu передають акти протягом 14 днів.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 516 передбачає видачу karty pobytu після pobranie odcisków linii papilarnych для cudzoziemców, які досягли 6 років і належать до перелічених перехідних категорій; виняток — коли pobranie є фізично неможливим.",
      ...
      foreignersCase:
        "Встановіть категорію за Art. 516, вік на момент дії правила та причину відсутності odciski; збережіть повідомлення органу й медичне або інше підтвердження неможливості, якщо воно є.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 517 встановлює, що записи про cudzoziemców зі старого wykaz переходять до wykaz за новим законом і зберігаються на первісно визначений строк; до старих zakazy ponownego wjazdu застосовуються правила Dział X Rozdział 2.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 518 передбачає передачу даних, зібраних за старими правилами в krajowy zbiór rejestrów, ewidencji i wykazu «System Pobyt», до krajowy zbiór, що ведеться на підставі нового закону.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 519 встановлює, що Szef Urzędu do Spraw Cudzoziemców, призначений на підставі uchylona ustawa, є Szefem Urzędu do Spraw Cudzoziemców у розумінні нової ustawa.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 520 визначає, що dotychczasowe przepisy wykonawcze, видані на підставі перелічених старих статей, зберігають moc до набрання чинності актами на підставі нової ustawa, але не довше 12 місяців від дня її wejścia w życie.",
