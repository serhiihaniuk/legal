...
export const foreignersActPart02 =
  defineEditorialPart<"ustawa-o-cudzoziemcach">({
    ...
    entries: [
      ...
      },
      {
        ...
        summary: foreignersLaw.text`${foreignersLaw.article("64", "Art. 64")} пов’язує окремі робочі цілі візи з доказом допуску до праці: zezwolenie na pracę, oświadczenie о дорученні роботи або заświadczenie для роботи сезонної. Тривалість pobytu за візою не може бути довшою за строк підтвердного документа і межі відповідного типу wiza.`,
        rules: [
          {
            locator: "Art. 64 ust. 1–3",
            explanation: foreignersLaw.text`Для ${foreignersLaw.article("60", "Art. 60")} ust. 1 pkt 6 подається zezwolenie na pracę за названими положеннями закону про powierzanie pracy, якщо дозвіл не є потрібним; для pkt 5 — oświadczenie, внесене до ewidencja; для pkt 5a — заświadczenie про сезонний wniosek, внесений до ewidencja.`,
          },
          {
        ...
        claims: [
          {
            ...
            sourceLocator:
              "Art. 72 у zw. z Art. 27 rozporządzenie nr 2018/1861",
          },
          {
            kind: "practical-inference",
      ...
      },
      {
        ...
        claims: [
          {
            kind: "statute-text",
            text: foreignersLaw.text`${foreignersLaw.article("81", "Art. 81")} у локальному corpus має статус repealed і містить лише позначку „(uchylony)”. Чинного тексту правила в цій статті немає.`,
        ...
        summary: foreignersLaw.text`${foreignersLaw.article("81", "Art. 81")} скасовано: corpus прямо позначає його як „uchylony”. Наступний чинний блок про Przedłużanie wiz починається з ${foreignersLaw.article("82", "Art. 82")}.`,
        rules: [
          {
            locator: "Art. 81",
            explanation:
          ...
          {
            locator: "status przepisu",
            explanation: foreignersLaw.text`Для події до скасування потрібно знайти редакцію, яка діяла тоді, і перевірити przepisy przejściowe; current corpus не робить ${foreignersLaw.article("81", "Art. 81")} чинною нормою.`,
          },
        ],
      ...
      },
      {
        ...
        foreignersCase: foreignersLaw.text`Перевірте SIS-запис, державу-ініціатора, запит через Policja, дату консультації та рішення/заміr wojewoda або Szef Urzędu; окремо доведіть усі умови ${foreignersLaw.article("82", "Art. 82")}.`,
      },
    ],
  })
