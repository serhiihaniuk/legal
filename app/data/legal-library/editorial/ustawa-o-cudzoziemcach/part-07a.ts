...
export const foreignersActPart07a = defineEditorialPart<
  ...
  entries: [
    {
      ...
      legalEffect:
        "Art. 194 є підставою для підзаконного регулювання, але не встановлює самостійно потрібну суму або закритий перелік документів.",
      foreignersCase:
        "Визначте, чи підстава справи належить до art. 186 або art. 187, потім перевірте чинне rozporządzenie та подайте докази саме тих коштів і документів, які воно передбачає.",
    },
    {
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–4",
          explanation:
            "Доходи для названих випадків рахуються за art. 140 ust. 2, а безперервність оцінюється за правилами про допустимі перерви та їхні винятки.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      legalEffect:
        "Застосування Art. 196 може припинити справу до розгляду права на pobyt stały по суті; це не те саме, що odmowa udzielenia zezwolenia за Art. 197.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 197 передбачає odmowę udzielenia zezwolenia na pobyt stały, якщо не виконано art. 195 або існує запис у wykazie osób niepożądanych чи SIS для odmowa wjazdu i pobytu, або цього вимагають оборона, безпека, porządek publiczny чи interes Rzeczypospolitej Polskiej.",
      ...
      rules: [
        {
          ...
          explanation:
            "Перевіряйте кожну підставу окремо: невиконання Art. 195, записи SIS або wykaz, безпека, interes RP та шлюб із метою обходу правил мають різний предмет доказування.",
        },
        {
        ...
        },
        {
          locator: "ust. 2–4",
          explanation:
            "Для osoby polskiego pochodzenia, osoby z azyl та визначеного громадянина UK діють спеціальні переліки; для pkt 7 не застосовується art. 79 KPA.",
        },
      ],
      legalEffect:
        "Навіть виконання умов Art. 195 не виключає обов’язкової відмови за Art. 197, якщо орган встановить відповідну законну обставину.",
      foreignersCase:
        "У рішенні позначте конкретний pkt Art. 197, перевірте докази органу та застосовний спеціальний режим заявника; не замінюйте аналіз мотивів загальним посиланням на безпеку або SIS.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Якщо діє Art. 197 ust. 1 pkt 3 через запис cudzoziemca в SIS для odmowa wjazdu i pobytu, Art. 198 допускає udzielenie zezwolenia з урахуванням причин запису та zagrożeń з art. 27 lit. d rozporządzenia nr 2018/1861.",
      ...
      legalEffect:
        "SIS-запис не описує наперед результат справи: Art. 198 дає спеціальний шлях оцінки, але не скасовує інші умови й підстави відмови.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 199 передбачає cofnięcie zezwolenia na pobyt stały через оборону або безпеку держави, porządek publiczny, interes RP, неправдиві дані чи документи, неправдиві свідчення або підроблення, остаточний вирок у Польщі за умисний злочин із карою щонайменше 3 роки або залишення Польщі понад 6 років.",
          sourceLocator: "Art. 199 ust. 1 pkt 1–5",
        },
        {
          kind: "statute-text",
          text: "Для окремих категорій Art. 195 діють спеціальні підстави; дозвіл, наданий через шлюб з obywatel polski, може бути відкликано, якщо розлучення відбулося протягом 2 років від дня надання дозволу. Для встановлення обставин pkt 3 не застосовується art. 79 KPA.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 4",
          explanation:
            "У частині встановлення неправди або підроблення діє спеціальне виключення з art. 79 KPA.",
        },
      ],
      legalEffect:
        "Cofnięcie є окремим рішенням після надання дозволу; воно не випливає лише з підозри без встановлення законної підстави.",
      foreignersCase:
        "Порівняйте повідомлені факти з pkt Art. 199, датами виїздів, вироком або документами справи та надайте пояснення щодо винятків; для шлюбу перевірте дату дозволу й дату розлучення.",
    },
    {
    ...
    },
    {
      ...
      legalEffect:
        "Art. 201 розподіляє компетенцію, але сам не встановлює матеріальну підставу для надання чи cofnięcie; її треба шукати в інших статтях.",
      foreignersCase:
        "На decyzja перевірте орган, інстанцію, вид дії та підставу порівняно з Art. 195 або Art. 199; помилковий орган є окремим процесуальним питанням.",
    },
    {
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 204 делегує ministrowi właściwemu do spraw wewnętrznych визначення в rozporządzeniu wzoru wniosku про pobyt stały, кількості та технічних вимог до фотографій, wzoru stempla, способу зняття відбитків і способу запису та передачі даних для персоналізації karty pobytu.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Актуальний wzór formularza, вимоги до фото та технічні правила треба перевіряти в rozporządzenie, а не виводити лише з Art. 204.",
        },
        {
          locator: "ust. 2",
          explanation:
      ...
      legalEffect:
        "Art. 204 не встановлює нової підстави для pobyt stały і не називає кількості фотографій; він визначає межі технічного rozporządzenie.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "У провадженні про pobyt stały для małżonek obywatela polskiego орган встановлює, чи шлюб був укладений або існує з метою обходу правил в’їзду, przejazdu, pobytu чи wyjazdu cudzoziemców; для цього застосовуються art. 169 ust. 2, 4 і 5.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "Порядок встановлення обставин визначається відсиланням до конкретних частин Art. 169.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      legalEffect:
        "Art. 206 стосується легальності перебування під час конкретного провадження і не замінює рішення про udzielenie zezwolenia та документ подорожі.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "У провадженні про udzielenie або cofnięcie zezwolenia na pobyt stały стороною є виключно cudzoziemiec, про якого йдеться відповідно в art. 195 або art. 199.",
      ...
      legalEffect:
        "Art. 207a стосується процесуального статусу, а не матеріального права на zezwolenie або способу його відкликання.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Коли орган іншої держави Schengen просить консультацію за art. 28 або 29 rozporządzenia nr 2018/1861, відповідний wojewoda встановлює, чи є підстави cofnięcia pobyt stały, враховуючи причини SIS-запису та загрози з art. 28 lit. d або art. 29 lit. d цього регламенту.",
      ...
      legalEffect:
        "Консультаційна процедура може вплинути на оцінку cofnięcie, але Art. 208 сам не є рішенням про відкликання дозволу.",
      foreignersCase:
        "З’ясуйте, який саме SIS-запит надійшов, і контролюйте дати повідомлень та рішення; фактичний результат залежить від встановлених підстав Art. 199.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Якщо дані cudzoziemca внесені до SIS для цілей art. 3 ust. 1 rozporządzenia nr 2018/1860, wojewoda або Szef Urzędu у другій інстанції через Komendant Główny Policji проводить консультацію чи повідомляє державу, що внесла дані, залежно від того, чи супроводжувалося рішення zakaz ponownego wjazdu.",
      ...
      rules: [
        {
          locator: "pkt 1",
          explanation:
            "За рішенням із zakaz ponownego wjazdu орган звертається про консультацію за art. 9 ust. 1 rozporządzenia nr 2018/1860.",
        },
        {
          locator: "pkt 2–3",
          explanation:
      ...
      legalEffect:
        "Art. 208a встановлює координацію з державою, що внесла SIS-дані, але не замінює оцінку умов pobyt stały та рішення компетентного органу.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Якщо орган іншої держави Schengen просить консультацію за art. 10 або 11 rozporządzenia nr 2018/1860, а cudzoziemiec має pobyt stały, відповідний wojewoda встановлює, чи є підстави cofnięcia дозволу.",
          sourceLocator: "Art. 208b ust. 1",
        },
        {
          kind: "statute-text",
          text: "Правила строків відповідають Art. 208: повідомлення через Komendant Główny Policji — протягом 10 днів, можливе продовження максимум на 12 днів, а передача іншій державі — протягом 14 днів або продовженого строку.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Після запиту за art. 10 або 11 регламенту орган перевіряє саме підстави cofnięcia, а не просто чинність картки.",
        },
        {
          locator: "ust. 2–4",
          explanation:
      ...
      foreignersCase:
        "Збережіть повідомлення про консультацію, перевірте SIS-підставу й дати, а заперечення щодо cofnięcie будуйте на конкретних фактах і Art. 199.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 209 має позначку «uchylony» і не містить чинного правила про pobyt stały або іншу процедуру.",
          sourceLocator: "Art. 209",
        },
      ],
      summary:
        "Art. 209 є uchylony у чинному тексті; його не можна використовувати як самостійну правову підставу.",
      rules: [
        {
          locator: "Art. 209",
          explanation:
      ...
      legalEffect:
        "У чинній редакції Art. 209 не встановлює правового наслідку, який можна було б застосувати до заяви.",
      foreignersCase:
        "Якщо рішення або консультація посилається на Art. 209 як на чинну норму, перевірте цитування та вимагайте аналізу актуальної правової підстави.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Decyzję про udzielenie zezwolenia na pobyt stały видають протягом 6 місяців; цей строк рахується від останньої з подій: особистого подання або stawiennictwo, формально повного wniosku чи усунення braków, подання документів за art. 203 ust. 2 pkt 2 або безрезультатного спливу строку на їх подання.",
      ...
      legalEffect:
        "Art. 210 визначає строки розгляду, але пропуск строку не перетворює заяву автоматично на позитивне рішення; наслідки бездіяльності треба оцінювати окремо.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 211 передбачає udzielenie zezwolenia na pobyt rezydenta długoterminowego UE на czas nieoznaczony особі, яка легально й безперервно перебувала в Польщі щонайменше 5 років і має стабільний та регулярний dochód, ubezpieczenie zdrowotne та підтверджене знання польської мови.",
          sourceLocator: "Art. 211 ust. 1",
        },
        {
          kind: "statute-text",
          text: "Доходи оцінюють за art. 140 ust. 2 за 2 роки у випадку art. 212 ust. 1 pkt 1 і за 3 роки в інших випадках; знання мови підтверджується, зокрема, рівнем B1 або документом про навчання польською, а вимога мови не застосовується до особи, молодшої 16 років.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "Розрахунок dochód залежить від того, чи використовується спеціальне зарахування з art. 212 ust. 1 pkt 1; не застосовуйте один період до всіх справ.",
        },
        {
          locator: "ust. 3–5",
          explanation:
      ...
      foreignersCase:
        "Побудуйте розрахунок 5 років за Art. 212, окремо підтвердьте dochód, ubezpieczenie та мову прийнятним документом і звірте періоди безпосередньо перед wniosek.",
    },
    {
      ...
      foreignersCase:
        "Складіть календар усіх віз, дозволів, процедур і виїздів із позначенням «рахується повністю», «половина» або «не рахується» за відповідним пунктом Art. 212.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 213 вимагає odmowy wszczęcia postępowania про pobyt rezydenta długoterminowego UE, якщо на день wniosku cudzoziemiec перебуває нелегально або на названій візі, для навчання чи szkolenie, очікує навчання, має гуманітарний, tolerowany, azyl, ochronę czasową або просить захист, користується ICT/іншим переліченим дозволом чи малим прикордонним рухом.",
          sourceLocator: "Art. 213 ust. 1 pkt 1 lit. a–h",
        },
        {
          kind: "statute-text",
          text: "Також перешкодами є транскордонний працівник або usługodawca, затримання, strzeżony ośrodek, zakaz opuszczania kraju, позбавлення волі, незавершений dobrowolny wyjazd після рішення про powrót, обов’язок виїхати за art. 299 ust. 6, перебування поза Польщею та неподання відбитків у строк art. 219 ust. 6.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "Неподання odcisków linii papilarnych під час wniosku або у строк art. 219 ust. 6 є окремою підставою odmowa wszczęcia.",
        },
      ],
      legalEffect:
        "Art. 213 відрізняється від відмови у наданні статусу за Art. 214: йдеться про недопустимість початку провадження за наявної обставини.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Cudzoziemcowi відмовляють у наданні zezwolenia na pobyt rezydenta długoterminowego UE, якщо він не виконує вимоги Art. 211 ust. 1 або цього вимагають оборона, безпека держави чи безпека та porządek publiczny; на ці безпекові обставини не можна посилатися з економічних причин.",
      ...
      rules: [
        {
          locator: "ust. 1 pkt 1",
          explanation:
            "Спочатку перевірте сукупні вимоги Art. 211, а не лише 5-річний строк.",
        },
        {
      ...
      foreignersCase:
        "У рішенні розділіть невиконання умов Art. 211 і безпекову підставу, перевірте фактичні мотиви та не погоджуйтеся з чисто економічним обґрунтуванням під pkt 2.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Якщо дані cudzoziemca внесені до SIS для odmowa wjazdu i pobytu, під час оцінки Art. 214 ust. 1 pkt 2 враховують причини рішення держави, що внесла запис, і zagrożenia з art. 27 lit. d rozporządzenia nr 2018/1861.",
      ...
      legalEffect:
        "Art. 214a визначає спосіб міжнародної перевірки безпекової підстави Art. 214 і не скасовує перевірку решти умов Art. 211.",
      foreignersCase:
