  ...
  entries: [
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 139t ust. 1 вимагає, щоб jednostka przyjmująca подала заяву про zezwolenie з art. 139o ust. 1 для cudzoziemiec, який перебуває в Польщі, не пізніше останнього дня його legalnego pobytu; ust. 2–3 відповідно відсилають до art. 108.",
      ...
      summary:
        "Для заяви за art. 139o ust. 1 закон встановлює різні правила для cudzoziemiec, який уже перебуває в Польщі, і для особи за межами Польщі.",
      rules: [
        {
          locator: "ust. 1",
          explanation:
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "У ситуації ust. 1 положення art. 108 застосовуються відповідно; це не скасовує перевірку умов ICT-дозволу.",
        },
        {
          locator: "ust. 3",
          explanation:
            "Якщо cudzoziemiec перебуває за межами Польщі, art. 108 ust. 1 pkt 2 і ust. 2 застосовуються відповідно після його законного в’їзду.",
        },
      ],
      legalEffect:
        "Норма визначає строк і процесуальну модель подання заяви для zezwolenie з art. 139o ust. 1; сама заява не підтверджує виконання матеріальних умов дозволу.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 139u передбачає відповідне застосування до zezwolenie з art. 139o ust. 1 положень art. 139g, 139h, 139i, art. 139j ust. 3, art. 139k та art. 139m.",
          sourceLocator: "Art. 139u",
        },
      ],
      summary:
        "Art. 139u є нормою-відсиланням: правила для дозволу з art. 139o ust. 1 треба читати разом із переліченими положеннями розділу ICT.",
      rules: [
        {
          locator: "cały przepis",
          explanation:
            "Для кожного питання визначте конкретну норму з art. 139g, 139h, 139i, art. 139j ust. 3, art. 139k або art. 139m і застосовуйте її відповідно.",
        },
      ],
      legalEffect:
      ...
      foreignersCase:
        "У висновку назвіть конкретний застосований cross-reference і перевірте його умови за текстом відповідної статті, а не лише за art. 139u.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 139w ust. 1 зобов’язує wojewoda передати Szef Urzędu копію рішення про udzielenie або cofnięcie дозволу з art. 139o ust. 1, а ust. 2 зобов’язує Szef Urzędu передати відповідному wojewoda інформацію про cudzoziemiec, названу в art. 22 ust. 1 pkt 8a lit. d tiret pierwsze.",
          sourceLocator: "Art. 139w ust. 1–2",
        },
      ],
      summary:
        "Стаття встановлює обмін даними між wojewoda та Szef Urzędu у справах дозволу за art. 139o ust. 1.",
      rules: [
        {
          locator: "ust. 1",
          explanation:
        ...
        },
        {
          locator: "ust. 2",
          explanation:
            "Szef Urzędu передає wojewoda, який надав дозвіл, інформацію про cudzoziemiec у межах даних, названих у art. 22 ust. 1 pkt 8a lit. d tiret pierwsze.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 140 ust. 1 встановлює сукупні умови zezwolenie на pobyt czasowy для роботи cudzoziemiec, delegowany przez pracodawcę zagranicznego: zezwolenie na pracę або письмову заяву роботодавця, страхування, стабільний і регулярний дохід та місце проживання в Польщі.",
          sourceLocator: "Art. 140 ust. 1 pkt 1–4",
        },
        {
          kind: "statute-text",
          text: "За art. 140 ust. 2 щомісячний дохід має перевищувати поріг, що дає право на świadczenia pieniężne z pomocy społecznej, щодо cudzoziemiec і кожного члена сім’ї на його утриманні.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 141 не застосовує art. 100 ust. 1 pkt 9 до cudzoziemiec, тимчасово delegowany для świadczenie usług у Польщі роботодавцем, що має siedziba в іншій державі UE, EFTA–EOG або Швейцарії, якщо cudzoziemiec має право перебувати й zatrudnienie в цій державі.",
      ...
      legalEffect:
        "Art. 141 прибирає тільки застосування art. 100 ust. 1 pkt 9 у визначеній ситуації; інші умови й підстави відмови залишаються чинними.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 142 встановлює умови zezwolenie на pobyt czasowy для prowadzenie działalności gospodarczej: особисті умови cudzoziemiec, а також економічні умови щодо podmiot, який веде діяльність.",
          sourceLocator: "Art. 142 ust. 1–5",
        },
        {
          kind: "practical-inference",
          text: "Саме створення spółka, частка або функція в zarząd не доводять виконання фінансових, кадрових чи майбутніх економічних умов art. 142.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 4–5",
          explanation:
            "Для доходу застосовується art. 140 ust. 2. Для громадянина Туреччини у визначеній ситуації застосовується art. 41 Protokołu dodatkowego до Układ stowarzyszeniowy EWG–Turcja.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 142a дозволяє ministrowi właściwemu do spraw wewnętrznych у porozumieniu з ministrem właściwym do spraw pracy та ministrem właściwym do spraw gospodarki встановити rozporządzeniem річний limit дозволів у ситуації art. 142 ust. 3.",
      ...
      summary:
        "Стаття створює делегацію для річних лімітів лише щодо дозволів у ситуації art. 142 ust. 3.",
      rules: [
        {
          locator: "ust. 1",
          explanation:
      ...
      legalEffect:
        "Сам art. 142a не встановлює числа limit; юридично значущі чинне rozporządzenie та офіційне obwieszczenie.",
      foreignersCase:
        "Уточніть, чи справа підпадає під art. 142 ust. 3, знайдіть чинне rozporządzenie для відповідного року й перевірте офіційне оголошення про досягнення limit.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 143 ust. 1 передбачає odmowa udzielenia zezwolenie на pobyt для діяльності з art. 142 ust. 3, якщо в поточному календарному році досягнуто limit, що стосується цього cudzoziemiec; ust. 2 відсилає до art. 117 pkt 1–2.",
          sourceLocator: "Art. 143 ust. 1–2",
        },
      ],
      summary:
        "Річний limit може бути підставою для відмови у наданні бізнесового дозволу, але лише у вузькій ситуації art. 142 ust. 3.",
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Поза випадками art. 100 дозвіл відмовляють, коли досягнуто limit, що стосується конкретного cudzoziemiec, визначений на підставі art. 142a ust. 1.",
        },
        {
          locator: "ust. 2",
          explanation:
            "До odmowa udzielenia застосовуються art. 117 pkt 1 і 2; їхні умови треба перевірити окремо.",
        },
      ],
      legalEffect:
        "Норма не робить будь-який досягнутий limit загальною забороною бізнесового pobyt і не стосується справ поза art. 142 ust. 3.",
      foreignersCase:
        "Зафіксуйте тип дозволу, роль cudzoziemiec за art. 142 ust. 3, календарний рік і офіційний статус limit. Не називайте наслідок odmowa wszczęcia.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 143a вимагає, щоб рішення про udzielenie дозволу в ситуації art. 142 ust. 3 містило okres ważności, podmiot powierzający pracę та stanowisko, на якому cudzoziemiec має працювати.",
      ...
      summary:
        "У бізнесовому дозволі за art. 142 ust. 3 рішення фіксує строк і конкретні параметри роботи.",
      rules: [
        {
          locator: "ust. 1",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 144 ust. 1 встановлює умови zezwolenie на pobyt czasowy у celu kształcenia się na studiach: мета підготовки або продовження studia у відповідній jednostka, zaświadczenie, оплата платного навчання, страхування та кошти на утримання, повернення або транзит і studia.",
          sourceLocator: "Art. 144 ust. 1–3",
        },
        {
          kind: "statute-text",
          text: "Art. 144 ust. 4–18 регулює zatwierdzenie jednostka prowadząca studia, винятки з обов’язку zatwierdzenia, перевірки, строк затвердження, список і можливість розпорядження про підготовчий курс.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 1a–1c",
          explanation:
            "Місячні кошти мають перевищувати поріг соціальної допомоги після врахування витрат на житло; ust. 1c містить спеціальне правило для громадян держав, названих у положеннях art. 113b.",
        },
        {
          locator: "ust. 2–3",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 144a дозволяє ministrowi właściwemu do spraw wewnętrznych видати decyzja про zakaz przyjmowania cudzoziemców одиницею з art. 144 ust. 5 на строк до 5 років за прямо названих обставин.",
      ...
      legalEffect:
        "Zakaz стосується прийому cudzoziemców відповідною jednostka. Він не є автоматичним скасуванням кожного вже виданого дозволу; для продовження навчання діє art. 144b.",
      foreignersCase:
        "Встановіть, яка саме decyzja була видана, коли вона стала ostateczna і чи одиниця входить до актуального списку. Для студента перевірте дату його дозволу та застосування art. 144b.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 144b ust. 1 забороняє jednostka prowadząca studia приймати cudzoziemców на studia з дня, коли остаточними стали рішення про odmowa zatwierdzenia, odmowa przedłużenia, cofnięcie zatwierdzenia або zakaz з art. 144a ust. 1.",
          sourceLocator: "Art. 144b ust. 1",
        },
        {
          kind: "statute-text",
          text: "Cudzoziemiec, якому до цієї дати надано дозвіл з art. 144, може продовжити навчання, а в його провадженні про побит не застосовується вимога zatwierdzenie jednostka.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–3",
          explanation:
            "Особа з дозволом art. 144, наданим до цієї дати, може продовжувати kształcenie; у процедурі її дозволу не застосовується вимога затвердження jednostka.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 145 встановлює строки першого та наступного zezwolenie з art. 144 для першого року studia, програм мобільності, szkoła doktorska і підготовчого курсу.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 145a, крім випадків art. 99, вимагає odmowa wszczęcia провадження про дозвіл для studia, якщо в день заяви cudzoziemiec має дозвіл art. 139a ust. 1 для pracy як pracownik odbywający staż або ubiega się про дозвіл art. 127 чи вже його має.",
      ...
      rules: [
        {
          locator: "pkt 1",
          explanation:
            "На дату подання перевіряється наявність дозволу з art. 139a ust. 1 для роботи як pracownik odbywający staż.",
        },
        {
          locator: "pkt 2",
          explanation:
            "На ту саму дату перевіряється, чи cudzoziemiec просить дозвіл з art. 127 або вже його має.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 146 має в локальному офіційному corpus позначку «(uchylony)».",
          sourceLocator: "Art. 146",
        },
      ],
      summary:
        "Art. 146 скасована і не містить чинної нормативної диспозиції.",
      rules: [
        {
          locator: "cały przepis",
          explanation:
            "Не використовуйте Art. 146 як самостійну чинну підставу; перевіряйте актуальні сусідні положення та перехідні правила, якщо документ посилається на цей номер.",
        },
      ],
      legalEffect:
        "Позначка «(uchylony)» означає, що в актуальному тексті немає чинного правила, яке можна застосувати як Art. 146.",
      foreignersCase:
        "Встановіть дату і контекст старого посилання на Art. 146 та зіставте його з редакцією акта, чинною на відповідну подію.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 147 встановлює спеціальні підстави odmowa udzielenia zezwolenie з art. 144: діяльність jednostka для сприяння незаконному в’їзду чи побиту, обґрунтовані сумніви щодо заявленої мети та, для наступної або повторної першої заяви, використання попереднього дозволу не за метою.",
          sourceLocator: "Art. 147 ust. 1–2",
        },
        {
          kind: "statute-text",
          text: "За art. 147 ust. 3 у разі повторної першої або наступної заяви можна відмовити, якщо cudzoziemiec був skreślony з listy studentów або doktorantów.",
      ...
      rules: [
        {
          locator: "ust. 1 pkt 1–2",
          explanation:
            "Поза art. 100 ust. 1 pkt 1–5, 8 і 9 дозвіл відмовляють, якщо jednostka переважно сприяє незаконному в’їзду/побиту або є обґрунтовані сумніви, що заявлена мета pobyt не відповідає дійсній.",
        },
        {
          locator: "ust. 2",
          explanation:
      ...
      legalEffect:
        "Art. 147 може перешкоджати udzielenie навчального дозволу навіть за наявності документів навчання; кожну підставу треба довести в конкретній процедурі.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 148 передбачає cofnięcie zezwolenie з art. 144, якщо його використовують не за наданою метою, виникла обставина art. 100 ust. 1 pkt 2, 4, 5 або 8, або jednostka переважно сприяє незаконному в’їзду чи pobyt.",
          sourceLocator: "Art. 148 ust. 1 pkt 1–3",
        },
        {
          kind: "statute-text",
          text: "За art. 148 ust. 2 дозвіл можна cofnięcie, якщо cudzoziemiec був skreślony з listy studentów або doktorantów.",
      ...
      rules: [
        {
          ...
          explanation:
            "Поза art. 101 pkt 1–2 wojewoda cofnie дозвіл, якщо мета використання не відповідає наданій, настала одна з названих обставин art. 100 або jednostka діє переважно для незаконного в’їзду/побиту.",
        },
        {
          locator: "ust. 2",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 148a визначає обов’язкові дані в zaświadczenie з art. 144 ust. 1 pkt 1 lit. a: особу, jednostka, початок і строк навчання, напрям, оплату, мову, рівень мови та програму/угоду мобільності; для продовження додається інформація про перебіг навчання.",
      ...
      legalEffect:
        "Стаття уніфікує доказ навчальної підстави; неповний або невідповідний zaświadczenie може впливати на оцінку заяви, але не замінює інших умов art. 144.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 148b зобов’язує орган у справі udzielenie або cofnięcie дозволу для studia перевірити дані cudzoziemiec у відповідному wykaz за art. 343a, 344 або 345 Prawo o szkolnictwie wyższym i nauce.",
          sourceLocator: "Art. 148b ust. 1",
        },
        {
          kind: "statute-text",
          text: "Дані в цих wykaz вважаються правдивими, але презумпцію можна спростувати лише документом urzędowy, зокрема zaświadczenie з art. 144 ust. 1 pkt 1 lit. a.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 149 вимагає вести навчальне провадження з урахуванням дати початку навчання, повідомляє rektor або kierownik про наданий дозвіл і покладає на заклад обов’язок повідомити про skreślenie.",
          sourceLocator: "Art. 149 ust. 1–3",
        },
        {
          kind: "statute-text",
          text: "Wojewoda щороку перевіряє дані осіб із дозволами art. 144 ust. 1 або 3 у відповідних wykaz у період безпосередньо після 1 березня та 1 жовтня.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 149a регулює намір скористатися mobilność studenta в іншій державі UE особою з польською student-візою або дозволом для studia: визначені jednostka або cudzoziemiec повідомляють орган цієї держави та Szef Urzędu, якщо право тієї держави вимагає такого повідомлення.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 149b допускає mobilność studenta в Польщі, якщо cudzoziemiec продовжує або доповнює studia з іншої держави UE, охоплений програмою/угодою мобільності, має документ з adnotacja «student», перебуває не довше 360 днів, а Szef Urzędu отримав повне повідомлення і не видав sprzeciw протягом 30 днів.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–5",
          explanation:
            "Zawiadomienie польською мовою містить дані особи, документа, програми, періоду й обох закладів; до нього додаються доказ документа, страхування, коштів за art. 144 ust. 1a і art. 150 та оплати платного навчання, а іноземні документи — з присяжним перекладом.",
        },
        {
          locator: "ust. 6–10",
          explanation:
        ...
        },
        {
          locator: "ust. 11–16",
          explanation:
            "Рішення про sprzeciw є ostateczna, про нього повідомляють державу, що видала документ; jednostka повідомляє про skreślenie, розпочата до art. 144b mobilność може продовжуватися, а без sprzeciw дані вилучаються з EES протягом 5 dni roboczych.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 149c регулює обмін інформацією про mobilność studenta: Szef Urzędu передає wojewoda повідомлення та інформацію про sprzeciw, wojewoda передає копію cofnięcie дозволу, а Szef Urzędu повідомляє держави мобільності та Straż Graniczna у названих випадках.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Szef Urzędu передає wojewoda повідомлення за art. 22 ust. 1 pkt 8a lit. f tiret drugie та інформацію про sprzeciw з інших держав UE.",
        },
        {
          locator: "ust. 2–4",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 150 уповноважує ministra właściwego do spraw wewnętrznych визначити rozporządzeniem мінімальні кошти на повернення/транзит для cudzoziemiec і утримуваних членів сім’ї, а також документи, що підтверджують можливість отримати ці та кошти на утримання за art. 144.",
      ...
      rules: [
        ...
        },
        {
          locator: "pkt 2",
          explanation:
            "Можуть бути визначені документи про можливість законно отримати кошти повернення/транзиту та кошти утримання за art. 144 ust. 1 pkt 2 lit. b.",
        },
      ],
      legalEffect:
        "Конкретні суми й документи походять із розпорядження; art. 150 сам не встановлює числового порога.",
      foreignersCase:
        "На дату заяви перевірте чинне rozporządzenie, державу повернення, склад сім’ї та відповідність поданих документів фінансовій вимозі art. 144 або art. 149b.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 151 встановлює умови zezwolenie на pobyt czasowy для naukowiec, який проводить badania naukowe або prace rozwojowe в zatwierdzona jednostka naukowa, включно зі страхуванням, коштами, письмовим зобов’язанням одиниці та umowa o przyjęciu.",
          sourceLocator: "Art. 151 ust. 1–1c",
        },
        {
          kind: "statute-text",
          text: "Art. 151 ust. 4–8 регулює zatwierdzenie jednostka, строк 5 років, інформаційні запити, cofnięcie/відмову у продовженні та офіційний список.",
      ...
      rules: [
        {
          locator: "ust. 1 pkt 1",
          explanation:
            "Cudzoziemiec подає health insurance або покриття лікування, достатні кошти чи документи про них і письмове зобов’язання jednostka повернути витрати у визначеному art. 151 випадку.",
        },
        {
        ...
        },
        {
          locator: "ust. 1a–1c",
          explanation:
            "Місячні кошти після відрахування витрат на житло мають перевищувати поріг соціальної допомоги; витрати на житло включають сталі оплати та комунальні послуги, а для громадян держав art. 113b діє спеціальне правило ust. 1c.",
        },
        {
          locator: "ust. 4–5",
          explanation:
        ...
        },
        {
          locator: "ust. 6–8",
          explanation:
            "Minister може відмовити у продовженні або cofnięcie затвердження за припинення досліджень, невиконання art. 152 ust. 4/art. 156, неправдиву чи недбалу угоду або фальшиві дані; за окремих підстав повторна заява заборонена 5 років, а список публікується офіційно.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 151a забороняє jednostka naukowa приймати cudzoziemców для badań або prac rozwojowych із дня ostateczna рішення про odmowa zatwierdzenia, odmowa przedłużenia або cofnięcie zatwierdzenia.",
          sourceLocator: "Art. 151a ust. 1",
        },
        {
          kind: "statute-text",
          text: "Особа, якій до цієї дати надано дозвіл з art. 151 або 151b, може продовжити дослідження/мобільність, а в її провадженні одноразово не застосовується вимога zatwierdzenie.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–3",
          explanation:
            "Cudzoziemiec з дозволом art. 151 або 151b, наданим до цієї дати, може продовжити відповідну діяльність; у його провадженні одноразово не застосовується вимога zatwierdzenie.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 151b регулює zezwolenie на pobyt czasowy для mobilność długoterminowa naukowca: частина досліджень у zatwierdzona польська jednostka, іноземний документ/віза з adnotacja «naukowiec», страхування, житло, кошти та umowa o przyjęciu.",
          sourceLocator: "Art. 151b ust. 1",
        },
        {
          kind: "statute-text",
          text: "Місячні кошти після витрат на житло мають перевищувати поріг соціальної допомоги щодо cudzoziemiec і кожного утримуваного члена сім’ї; ust. 3–4 визначають витрати на житло та виняток для держав art. 113b.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–4",
          explanation:
            "Кошти після витрат на житло перевищують поріг соціальної допомоги; витрати включають сталі оплати й комунальні послуги, а для громадян держав art. 113b діє ust. 4.",
        },
      ],
      legalEffect:
        "Дозвіл на довгострокову mobilność залежить від чинності іноземного документа, польської угоди та всіх фінансово-страхових умов; він не дорівнює звичайному дозволу art. 151.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 152 зобов’язує jednostka naukowa укласти з naukowiec umowa o przyjęciu після затвердження досліджень/праць її компетентними органами та визначає, що має бути враховано при такому затвердженні.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 4",
          explanation:
            "Jednostka видає письмове oświadczenie про покриття витрат, пов’язаних із decyzja про zobowiązanie до повернення, у випадку art. 337 ust. 5.",
        },
        {
          locator: "ust. 5",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 153 ust. 1 передбачає строк дозволу art. 151 на період badań або prac rozwojowych у Польщі, якщо підстава обґрунтовує побyt менше 3 років; ust. 2 встановлює аналогічний строк для mobilność długoterminowa, але не довший за іноземний документ або візу.",
      ...
      foreignersCase:
        "Порівняйте umowa o przyjęciu, строк проєкту, рішення і чинність іноземного документа; окремо перевірте, чи йдеться про art. 151 або art. 151b.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 154 встановлює спеціальні підстави odmowa udzielenia дозволу naukowiec: діяльність jednostka переважно для незаконного в’їзду/побиту, використання попереднього дозволу не за метою або закінчення чинності іноземного документа/допустимого строку візи для mobilność długoterminowa.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Поза art. 100 ust. 1 pkt 1–5, 8 і 9 відмовляють у дозволі art. 151, якщо jednostka головно полегшує naukowiec незаконний в’їзд або pobyt.",
        },
        {
          locator: "ust. 2",
          explanation:
            "У наступному дозволі art. 151 відмовляють, якщо обставини показують, що попередній дозвіл використано не за метою, з урахуванням названих у нормі загальних підстав.",
        },
        {
          locator: "ust. 3",
          explanation:
      ...
      legalEffect:
        "Art. 154 впливає на результат лише в межах відповідного виду дозволу; орган має назвати й обґрунтувати конкретну підставу.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 154a передбачає cofnięcie дозволу art. 151 або art. 151b, крім art. 101 pkt 1–2, якщо дозвіл використовується не за метою, виникла обставина art. 100 ust. 1 pkt 2, 4, 5 або 8, або jednostka переважно сприяє незаконному в’їзду/побиту naukowiec.",
      ...
      rules: [
        ...
        },
        {
          locator: "pkt 2",
          explanation:
            "Достатньою спеціальною підставою є хоча б одна обставина art. 100 ust. 1 pkt 2, 4, 5 або 8.",
        },
        {
          locator: "pkt 3",
          explanation:
      ...
      foreignersCase:
        "Зіставте мету в рішенні, фактичні завдання, статус jednostka та точний пункт art. 154a. Відокремте доказ обставини від висновку про cofnięcie.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 155, крім art. 99, передбачає odmowa wszczęcia провадження про дозвіл art. 151 або art. 151b, якщо на день заяви cudzoziemiec має дозвіл art. 139a ust. 1 для pracy як pracownik odbywający staż або ubiega się про art. 127 чи вже його має.",
          sourceLocator: "Art. 155 ust. 1 pkt 1–2",
        },
        {
          kind: "statute-text",
          text: "Для art. 151b odmowa wszczęcia додатково застосовується, якщо заяву подано того самого дня або протягом 14 днів від отримання Szef Urzędu zawiadomienie з art. 156b ust. 1 pkt 3.",
      ...
      rules: [
        {
          locator: "ust. 1 pkt 1–2",
          explanation:
            "На дату подання перевірте дозвіл ICT для pracownik odbywający staż і заяву/наявність дозволу art. 127.",
        },
        {
          locator: "ust. 2",
          explanation:
            "Для заяви art. 151b також перевірте, чи не подано її в день або в 14-денний строк після отримання Szef Urzędu повідомлення про mobilność з art. 156b ust. 1 pkt 3.",
        },
      ],
      legalEffect:
        "Наслідком є odmowa wszczęcia, а не остаточна odmowa udzielenia після оцінки матеріальних умов.",
      foreignersCase:
        "Встановіть усі заяви та дозволи на дату подання, дату отримання повідомлення Szef Urzędu і точно розрізняйте art. 151 та art. 151b.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 155a має в актуальному локальному corpus позначку «(uchylony)».",
          sourceLocator: "Art. 155a",
        },
      ],
      summary:
        "Art. 155a скасована і не містить чинного правила для дослідницької процедури.",
      rules: [
        {
          locator: "cały przepis",
          explanation:
            "Не використовуйте Art. 155a як чинну підставу; перевірте дату старого документа та актуальну норму, на яку він мав посилатися.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 156 зобов’язує jednostka naukowa невідкладно повідомляти właściwy wojewoda про події, що можуть перешкодити виконанню umowa o przyjęciu, а після завершення угоди протягом 2 місяців передавати ministrowi письмове підтвердження виконання досліджень/праць.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 156a регулює повідомлення, коли cudzoziemiec з польською візою або дозволом для badań має намір користуватися mobilność krótkoterminowa або długoterminowa naukowca в іншій державі UE.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 156b визначає умови mobilność krótkoterminowa naukowca в Польщі: затверджена jednostka, іноземний документ/віза з adnotacja «naukowiec» і повне zawiadomienie, після якого Szef Urzędu не видав sprzeciw протягом 30 днів.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–5",
          explanation:
            "Повідомлення польською мовою містить дані особи, документа, строків та обох установ; додаються докази документа, страхування, коштів за art. 151 ust. 1a/art. 157 і umowa o przyjęciu з перекладом, якщо документи іноземною мовою. Строк рахується від повного вручення.",
        },
        {
          locator: "ust. 6",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 156c регулює передачу інформації про cudzoziemiec і sprzeciw щодо mobilność між Szef Urzędu, wojewoda та органами держав UE, а також передачу копії cofnięcie дозволу дослідника.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Szef Urzędu передає відповідному wojewoda дані за art. 22 ust. 1 pkt 8a lit. c tiret drugie або zawiadomienie за lit. f tiret trzecie, включно з отриманою інформацією про sprzeciw інших держав.",
        },
        {
          locator: "ust. 2–3",
          explanation:
            "Wojewoda передає Szef Urzędu копію cofnięcie дозволу art. 151 особі в mobilność, а Szef Urzędu повідомляє держави UE, де ця особа користується мобільністю.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 156d зобов’язує wojewoda передати Szef Urzędu копію рішення про udzielenie або cofnięcie дозволу art. 151b, а Szef Urzędu — інформацію за art. 22 ust. 1 pkt 8a lit. d tiret trzecie.",
      ...
      rules: [
        {
          locator: "ust. 1",
          explanation:
            "Wojewoda передає Szef Urzędu копію рішення про udzielenie або cofnięcie zezwolenie art. 151b.",
        },
        {
          locator: "ust. 2",
          explanation:
            "Szef Urzędu передає wojewoda, який надав дозвіл, інформацію про cudzoziemiec у межах art. 22 ust. 1 pkt 8a lit. d tiret trzecie.",
        },
      ],
      legalEffect:
        "Це правило обліку між органами; воно не розширює строк або предмет дозволу art. 151b.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157 уповноважує ministra właściwego do spraw wewnętrznych встановити rozporządzeniem мінімальні кошти на повернення для naukowiec та osoby в mobilność długoterminowa naukowca, а також документи про можливість отримання цих коштів і коштів утримання.",
      ...
      rules: [
        ...
        },
        {
          locator: "pkt 3",
          explanation:
            "Можуть бути визначені документи, що підтверджують можливість законно отримати кошти повернення та утримання за art. 151 і art. 151b.",
        },
      ],
      legalEffect:
        "Art. 157 сам не називає суми; конкретні пороги й документи походять із відповідного rozporządzenie.",
      foreignersCase:
        "Визначте вид режиму — art. 151 чи art. 151b — і застосуйте чинне rozporządzenie до держави повернення, сім’ї та поданих доказів.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157a встановлює умови zezwolenie на pobyt czasowy dla stażysty: актуальне завершення або проходження studia, страхування, житло, кошти, письмове зобов’язання organizator stażu, детальна umowa stażu, відповідність стажу навчанню та мовний курс.",
          sourceLocator: "Art. 157a ust. 1–5",
        },
        {
          kind: "statute-text",
          text: "Art. 157a ust. 6–18 регулює zatwierdzenie organizator stażu, строки інформації, строк затвердження 2 роки, cofnięcie/відмову у продовженні та офіційний список.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–5",
          explanation:
            "Organizator до підписання дає переклад угоди зрозумілою мовою; кошти після витрат на житло перевищують поріг соціальної допомоги, з правилами про комунальні витрати та art. 113b.",
        },
        {
          locator: "ust. 6–14",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157b ust. 1 обмежує zezwolenie з art. 157a ust. 1 строком, потрібним для виконання umowa stażu, але не довше 6 місяців; ust. 2 дозволяє один наступний дозвіл до завершення угоди, також максимум на 6 місяців.",
          sourceLocator: "Art. 157b ust. 1–2",
        },
        {
          kind: "statute-text",
          text: "Art. 157b ust. 3–4 позначені як «(uchylony)».",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 3–4",
          explanation:
            "Ці положення скасовані й не застосовуються.",
        },
      ],
      legalEffect:
        "Карта побиту не може розширити строк понад межі art. 157b або продовжити угоду без відповідної правової підстави.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157c, крім art. 99, вимагає odmowa wszczęcia провадження про дозвіл dla stażysty, якщо на день заяви cudzoziemiec має дозвіл art. 139a ust. 1 для pracy як pracownik odbywający staż або ubiega się про art. 127 чи вже його має.",
      ...
      rules: [
        {
          locator: "pkt 1",
          explanation:
            "Перевіряється чинний дозвіл art. 139a ust. 1 для pracy як pracownik odbywający staż.",
        },
        {
          locator: "pkt 2",
          explanation:
            "Перевіряється подання або наявність дозволу art. 127.",
        },
      ],
      legalEffect:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157d встановлює odmowa udzielenia дозволу dla stażysty, крім art. 100 ust. 1 pkt 1–5, 8 і 9, за незаконно орієнтованого organizator, визначені порушення організатора, ліквідацію/банкрутство та обґрунтовані сумніви щодо мети pobyt; для наступного дозволу додано використання попереднього не за метою.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157e, крім art. 101 pkt 1–2, передбачає cofnięcie дозволу з art. 157a ust. 1, якщо його використовують не за метою, виникла обставина art. 100 ust. 1 pkt 2, 4, 5 або 8, або настала одна з обставин art. 157d ust. 1 pkt 1–3.",
      ...
      rules: [
        ...
        },
        {
          locator: "pkt 2",
          explanation:
            "Застосовується хоча б одна обставина art. 100 ust. 1 pkt 2, 4, 5 або 8.",
        },
        {
          locator: "pkt 3",
          explanation:
            "Застосовується хоча б одна з обставин art. 157d ust. 1 pkt 1–3, без розширення переліку за аналогією.",
        },
      ],
      legalEffect:
      ...
      foreignersCase:
        "Порівняйте рішення, umowa і реальну діяльність, встановіть дату події та перевірте точний cross-reference до art. 100 і 157d.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157f уповноважує ministra właściwego do spraw wewnętrznych встановити rozporządzeniem мінімальні кошти stażysta і його сім’ї на повернення/транзит та документи про можливість отримання цих коштів і коштів утримання за art. 157a ust. 1 pkt 1 lit. d.",
      ...
      rules: [
        ...
        },
        {
          locator: "pkt 2",
          explanation:
            "Розпорядження також визначає документи про можливість законно отримати кошти повернення та утримання за art. 157a.",
        },
      ],
      legalEffect:
        "Конкретну суму й перелік доказів встановлює rozporządzenie, а не сам текст art. 157f.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157g встановлює умови zezwolenie на pobyt czasowy dla wolontariusza для участі в European Voluntary Service: страхування, житло, кошти, umowa wolontariatu з визначеним змістом і zatwierdzenie jednostka органом.",
          sourceLocator: "Art. 157g ust. 1–4",
        },
        {
          kind: "statute-text",
          text: "Art. 157g ust. 5–17 регулює zatwierdzenie jednostka, строки перевірок, строк 2 роки, cofnięcie/відмову у продовженні та список затверджених jednostka.",
      ...
      rules: [
        ...
        },
        {
          locator: "ust. 2–4",
          explanation:
            "Місячні кошти після витрат на житло перевищують поріг соціальної допомоги; витрати охоплюють сталі оплати й комунальні послуги, з правилом для громадян держав art. 113b.",
        },
        {
          locator: "ust. 5–14",
          explanation:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157h ust. 1 надає дозвіл з art. 157g ust. 1 на строк, необхідний для виконання umowa wolontariatu, але не довше 1 року; ust. 2–3 позначені як «(uchylony)».",
      ...
      legalEffect:
        "Строк рішення не може бути довшим за межі art. 157h; лист організації не продовжує дозвіл без нової правової підстави.",
      foreignersCase:
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157i, крім art. 99, вимагає odmowa wszczęcia провадження про дозвіл dla wolontariusza, якщо на день заяви cudzoziemiec має дозвіл art. 139a ust. 1 для pracy як pracownik odbywający staż або ubiega się про art. 127 чи вже його має.",
      ...
      rules: [
        {
          locator: "pkt 1",
          explanation:
            "Перевіряється дозвіл art. 139a ust. 1 для роботи як pracownik odbywający staż.",
        },
        {
          locator: "pkt 2",
          explanation:
      ...
      foreignersCase:
        "Зафіксуйте дозволи й заяви на дату подання та наведіть у висновку конкретний пункт art. 157i.",
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157j встановлює odmowa udzielenia дозволу dla wolontariusza за незаконно орієнтованої jednostka, визначених порушень її керівництва/обов’язків, ліквідації або обґрунтованих сумнівів щодо мети pobyt; для наступного дозволу додано використання попереднього не за метою.",
    ...
    },
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Art. 157k, крім art. 101 pkt 1–2, передбачає cofnięcie дозволу з art. 157g ust. 1, якщо його використовують не за метою, виникла обставина art. 100 ust. 1 pkt 2, 4, 5 або 8, або настала обставина art. 157j ust. 1 pkt 1–3.",
          sourceLocator: "Art. 157k pkt 1–3",
        },
      ],
      summary:
        "Волонтерський дозвіл може бути скасований за використання не за метою, окремі загальні підстави або проблеми одиниці, названі art. 157j.",
      rules: [
        {
          locator: "pkt 1",
          explanation:
        ...
        },
        {
          locator: "pkt 2",
          explanation:
            "Потрібно встановити хоча б одну обставину art. 100 ust. 1 pkt 2, 4, 5 або 8.",
        },
        {
          locator: "pkt 3",
          explanation:
            "Потрібно встановити хоча б одну обставину art. 157j ust. 1 pkt 1–3; перелік не можна розширювати за аналогією.",
        },
      ],
      legalEffect:
      ...
      foreignersCase:
        "Порівняйте дозвіл, umowa і фактичні волонтерські послуги, встановіть дату події та перевірте конкретний пункт art. 100 або 157j.",
    },
  ],
})
