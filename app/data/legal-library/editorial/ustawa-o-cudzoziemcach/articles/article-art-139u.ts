  ...
  entries: [
    {
      ...
      rules: [
        {
          ...
          explanation: foreignersLaw.text`Для кожного питання визначте конкретну норму з ${foreignersLaw.article("139g", "art. 139g")}, ${foreignersLaw.article("139h", "art. 139h")}, ${foreignersLaw.article("139j", "art. 139j")} ust. 3, ${foreignersLaw.article("139k", "art. 139k")} або ${foreignersLaw.article("139m", "art. 139m")} і застосовуйте її відповідно.`,
        },
      ],
      legalEffect:
      ...
      foreignersCase: foreignersLaw.text`У висновку назвіть конкретне застосоване відсилання і перевірте його умови за текстом відповідної статті, а не лише за ${foreignersLaw.article("139u", "art. 139u")}.`,
    },
  ],
})
