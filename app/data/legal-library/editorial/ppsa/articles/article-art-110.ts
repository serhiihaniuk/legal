...
export default defineEditorialPart<"ppsa">({
  ...
  entries: [
    reviewed(
      ...
      [
        {
          locator: "Art. 110",
          explanation:
            "З’ясуйте, кого саме sąd вважає особою, яку треба zawiadomić як можливу stronę, і зафіксуйте нову дату rozprawy.",
        },
      ],
      ...
      "Якщо рішення про pobyt може зачіпати іншу особу, перевірте, чи суд має підстави повідомити її як stronę до продовження rozprawy."
    ),
  ],
})
