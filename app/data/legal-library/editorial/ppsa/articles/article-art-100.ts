...
export default defineEditorialPart<"ppsa">({
  ...
  entries: [
    reviewed(
      "ppsa-art-100",
      "З posiedzenie jawne протокол spisuje protokolant під керівництвом przewodniczący; з posiedzenie niejawne складають notatka urzędowa, якщо не видано orzeczenie, і її можна зберегти в системі sąd з kwalifikowanym podpisem elektronicznym.",
