...
export default defineEditorialPart<"ppsa">({
  ...
  entries: [
    reviewed(
      "ppsa-art-90",
      "Якщо спеціальний припис не встановлює іншого, posiedzenia sądowe є jawne, а sąd розглядає sprawy na rozprawie; навіть справу для posiedzenie niejawne можна направити на posiedzenie jawne z rozprawą.",
