  ...
  entries: authorLegalTextCitationsTree("ppsa", [
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: "Станом на 18.07.2026 Art. 74a є чинною нормою електронного doręczenie: вона охоплює умови згоди або подання електронного pismo, zawiadomienie, UPO, повторне повідомлення, fikcja doręczenia після чотирнадцяти днів, доступ до документа та підпис судових документів. Позначка про uchylenie в примітці 43 є майбутньою зміною з 1.10.2029, а не поточним статусом.",
          sourceLocator: "Art. 74a § 1–12, przypisy 42–43",
        },
      ],
      summary:
        "На 18.07.2026 Art. 74a — чинна окрема підстава електронного doręczenie; її майбутнє uchylenie заплановане на 1.10.2029.",
      rules: [
        {
          locator: "§ 1–2",
          explanation:
        ...
        },
        {
          locator: "§ 10–12",
          explanation:
            "Для prokurator, RPO, RPD та оскарженого organu pismo надсилається безпосередньо до elektroniczna skrzynka podawcza, а дата береться з UPO; листи суду, копії процесуальних листів і додатків та копії рішень, які суд вручає в електронній формі, повинні мати kwalifikowany podpis або kwalifikowana pieczęć.",
        },
        {
          locator: "Przypisy 42–43",
          explanation:
            "У зведеному тексті (tekst jednolity) примітка 43 відносить uchylenie Art. 74a до зміни, що набере чинності 1.10.2029; до цієї дати застосовується наведений чинний режим.",
        },
      ],
      legalEffect:
