...
export default defineEditorialPart<"ppsa">({
  ...
  entries: [
    reviewed(
      "ppsa-art-128",
      "Sąd z urzędu postanowi podjąć postępowanie, коли припиниться причина zawieszenie, зокрема після встановлення następcy prawnego, представника, завершення іншого провадження або визначення наступного zarządca sukcesyjny; після року без спадкоємців суд може звернутися про kurator spadku.",
