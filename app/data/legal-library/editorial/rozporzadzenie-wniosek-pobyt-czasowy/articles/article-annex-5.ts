  ...
  entries: [
    {
      ...
      claims: [
        {
          kind: "statute-text",
          text: regulationLaw.text`${regulationLaw.annex("5", "Załącznik nr 5")} є WZÓR четвертого додатка до wniosku для zezwolenia на pobyt у celu prowadzenia badań naukowych або mobilności długoterminowej naukowca; його заповнює cudzoziemiec і він містить дані polska jednostka naukowa та інформацію про програму або угоду мобільності.`,
      ...
      rules: [
        ...
        },
        {
          locator: "części I–II",
          explanation:
            "Текст містить dane osobowe та поля про jednostka naukowa на території Польщі: назву, адресу, правову підставу діяльності й REGON.",
        },
        {
          locator: "część III",
          explanation:
      ...
      legalEffect: regulationLaw.text`${regulationLaw.annex("5", "Załącznik nr 5")} подає структуровані відомості для дослідницької заяви, але сам заповнений wzór не доводить наявність усіх матеріальних умов zezwolenia.`,
      foreignersCase:
