...
import type { LegalAtlasData } from "~/data/legal-types"
...
import { LEGAL_STATE_DATE } from "~/data/legal-meta"
      ...
      },
      {
        ...
        nodes: [
          ...
          },
          {
            ...
            sources: [S.kpa, S.aliens, S.work, S.nsa],
          },
          {
            id: "study-loop",
