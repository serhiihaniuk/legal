...
export const kpaArticleExplanationsPart2: KpaArticleExplanation[] = [
  {
    article: "85",
    summary:
  ...
  },
  {
    article: "88a",
    summary:
      "Для військовослужбовця на активній службі штраф за порушення обов’язків з art. 88 § 1 замінено зверненням до командира про дисциплінарну відповідальність.",
    rules: [
      {
        locator: "єдиний блок",
        explanation:
  ...
  },
  {
    ...
    rules: [
      {
        locator: "§ 1",
        explanation: "Wezwanie повинно називати час, місце і предмет rozprawy.",
      },
      {
        locator: "§ 2",
        explanation:
  ...
  },
  {
    article: "96c",
    summary:
      "Якщо згоду на mediację не надано у строк з art. 96b § 3, mediacja не проводиться.",
    rules: [
      {
        locator: "єдиний блок",
        explanation:
    ...
    rules: [
      {
        locator: "§ 1",
        explanation:
          "Postanowienie про направлення вручається сторонам та органу співдії з art. 106 § 1.",
      },
      {
        locator: "§ 2",
        explanation:
    ...
    rules: [
      {
        locator: "§ 1",
        explanation:
          "Обставини, що можуть створювати сумнів, розкриваються негайно, включно з відповідними підставами з art. 24.",
      },
      {
        locator: "§ 2",
        explanation:
  ...
  },
  {
    ...
    rules: [
      ...
      {
        locator: "§ 3",
        explanation: "Витрати покриваються негайно після завершення mediacji.",
      },
    ],
    legalEffect:
  ...
  },
  {
    ...
    rules: [
      ...
      },
      {
        locator: "§ 2",
        explanation:
          "При zawieszeniu на прохання сторони орган пояснює наслідок трирічної бездіяльності з art. 98 § 2.",
      },
      {
        locator: "§ 3",
        explanation:
  ...
  },
  {
    ...
    foreignersCase:
      "У справі іноземця окремо треба перевірити, чи конкретний строк походить із KPA чи зі спеціального закону, бо art. 103 прямо говорить про строки кодексу.",
  },
  {
    article: "104",
    summary:
  ...
  },
  {
    article: "109",
    summary:
      "Decyzja вручається сторонам письмово, а у випадках з art. 14 § 2 може бути оголошена усно.",
    rules: [
      {
        locator: "§ 1–2",
        explanation:
    ...
    rules: [
      {
        locator: "§ 1–2",
        explanation:
          "Затверджує орган, перед яким її укладено; за потреби позиції іншого органу діє art. 106.",
      },
      {
        locator: "§ 3",
        explanation:
  ...
  },
  {
    article: "121a",
    summary:
      "До ugody, укладеної перед mediatorem, відповідно застосовуються art. 117–121.",
    rules: [
      {
        locator: "єдиний блок",
        explanation:
    ...
    foreignersCase:
      "У справі іноземця protokół mediacji треба відрізняти від ugody, яка ще повинна пройти відповідні етапи art. 117–121.",
  },
  {
    article: "122",
    summary:
  ...
  },
  {
    article: "122d",
    summary:
      "У справах, що вирішуються мовчазно, не діють art. 10 і 79a, а zawieszenie зупиняє строк на milczące załatwienie.",
    rules: [
      {
        locator: "§ 1",
        explanation:
    ...
    foreignersCase:
      "Якщо lex specialis допускає такий режим у справі іноземця, не можна очікувати окремого повідомлення за art. 79a перед спливом строку.",
  },
  {
    article: "122e",
    summary:
    ...
    rules: [
      {
        locator: "єдиний блок",
        explanation:
          "Для цих режимів закон фіксує умовний момент ефекту остаточної decyzji — чотирнадцять днів після спливу строку з art. 122c § 1.",
      },
    ],
    legalEffect:
  ...
  },
  {
    ...
    rules: [
      ...
      {
        locator: "§ 2",
        explanation: "У випадках art. 14 § 2 можливе усне оголошення.",
      },
      {
        locator: "§ 3",
        explanation:
  ...
  },
  {
    ...
    foreignersCase:
      "В odwołaniu іноземець може назвати конкретні докази до доповнення і, за потреби, просити повне з’ясування за умов § 2.",
  },
  {
    article: "137",
    summary:
    ...
    rules: [
      {
        locator: "§ 1",
        explanation:
          "Зв’язують обставини з art. 138 § 2 та wytyczne wykładni з § 2a; зміна застосовного права знімає пов’язаність.",
      },
      {
        locator: "§ 2",
        explanation:
  ...
  },
  {
    article: "140",
    summary:
      "У питаннях, не врегульованих art. 136–139, апеляційний орган відповідно застосовує правила першої інстанції.",
    rules: [
      {
        locator: "єдиний блок",
        explanation:
    ...
    foreignersCase:
      "У відсутньому спеціальному питанні odwołania іноземця можна посилатися на відповідне правило першої інстанції лише після перевірки art. 136–139.",
  },
  {
    article: "141",
    summary:
  ...
  },
  {
    ...
    foreignersCase:
      "У справі іноземця адресат первинного podania з art. 148 не завжди буде органом, який фактично проведе wznowione postępowanie.",
  },
  {
    article: "151",
    summary:
      "Після wznowienia орган або відмовляє в uchyleniu, або скасовує стару decyzję і вирішує суть заново; за бар’єром art. 146 лише констатує порушення.",
    rules: [
      {
        locator: "§ 1",
        explanation:
          "Результат залежить від підтвердження підстав art. 145–145b: збереження акта або uchylenie з новою decyzją.",
      },
      {
        locator: "§ 2",
        explanation:
          "Якщо art. 146 блокує скасування, organ stwierdza порушення права і пояснює, чому decyzję не усунуто.",
      },
      {
        locator: "§ 3",
        explanation:
    ...
    foreignersCase:
      "У sprawie cudzoziemca позитивне postanowienie o wznowieniu ще не гарантує uchylenia; organ може не підтвердити підставу або застосувати art. 146.",
  },
  {
    article: "152",
    summary:
  ...
  },
  {
    ...
    rules: [],
    legalEffect:
      "Жодного самостійного процесуального наслідку з art. 153 у чинному тексті немає.",
    foreignersCase:
      "У справі іноземця старе посилання на art. 153 треба перевіряти за редакцією, що діяла на дату відповідної дії або decyzji.",
  },
  {
    article: "154",
    summary:
    ...
    rules: [
      {
        locator: "єдиний блок",
        explanation:
          "Потрібні згода сторони, відсутність заборони lex specialis та суспільний або słuszny інтерес; застосовується форма decyzji з art. 154 § 2.",
      },
    ],
    legalEffect:
