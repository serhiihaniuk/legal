...
export const residenceOfficeDeadlines = {
  ...
  courtExample: law.text`Конкретний приклад містить ${law.external("рішення WSA w Poznaniu від 12.03.2026, II SAB/Po 314/25", judgmentUrl)}. Суд розглянув скаргу попри заперечення wojewody про зупинення строків, установив бездіяльність і зобов'язав завершити справу протягом 60 днів від отримання органом копії судового рішення, що набрало законної сили, разом із матеріалами. Водночас суд не визнав порушення грубим та відмовив у грошових санкціях, хоча присудив повернення судових витрат. На дату перевірки 23.09.2026 CBOSA позначає рішення як nieprawomocne, тобто таке, що ще не набрало законної сили. Його висновок не означає автоматичного надання дозволу.`,
} as const
    ...
    basis: [
      {
        ...
        locator:
          "II SAB/Po 314/25, operative part and reasons; nonfinal status checked 23.09.2026",
      },
    ],
  },
