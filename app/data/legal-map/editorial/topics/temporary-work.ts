...
export const temporaryWorkTopic: KnowledgeUnit<LegalMapTopicBody> =
  defineKnowledgeUnit({
    ...
    body: {
      ...
      documents: [
        documents.text`${documents.document("agency-user-arrangements", "Письмові узгодження агенції з pracodawcą użytkownikiem")}: визначають умови направлення та обмін відомостями між підприємствами. Це документи їхньої співпраці, не окремий обов'язковий додаток до кожної справи про перебування.`,
        documents.text`${documents.document("employment-agency-register", "Відомості KRAZ про обсяг послуг агенції")}: запис і види послуг зіставляють із запропонованим направленням. Це перевірка агенції, окрема від документів про право людини працювати.`,
      ...
      guide: defineLegalMapArticle({
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              documents.text`${documents.document("employment-agency-register", "KRAZ")}, rejestr agencji zatrudnienia, є реєстром регульованих послуг агенцій. За ${agencyArticle("art. 305")} важливий вид послуги: pośrednictwo pracy, посередництво у працевлаштуванні, не слід ототожнювати з pracą tymczasową. Відомості про конкретний суб'єкт, чинний запис і належний обсяг послуг читають разом. KRS або CEIDG підтверджують інші реєстраційні відомості про підприємство й самі не встановлюють права направляти тимчасових працівників.`,
