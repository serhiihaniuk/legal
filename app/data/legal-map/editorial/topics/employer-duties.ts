      ...
      guide: defineLegalMapArticle({
        ...
        sections: [
          ...
          },
          {
            ...
            paragraphs: [
              law.text`Суб'єкт, якому видано zezwolenie na pracę, повідомляє орган, що його видав. Для звичайного дозволу польського роботодавця це wojewoda. За ${law.article("19")} подіями є непочаток роботи протягом двох місяців від початкової дати чинності дозволу, перерва понад два місяці або завершення роботи більш як за два місяці до закінчення дозволу. ${law.article("20")} дає сім днів від настання відповідної обставини. Перший день звичайної роботи не створює окремого повідомлення про початок за цим приписом.`,
              "В офіційній довідці ці три послуги названо Powiadomienie o niepodjęciu pracy przez cudzoziemca (ZC-PNPC), Powiadomienie o przerwie w pracy cudzoziemca (ZC-PPPC) та Powiadomienie o zakończeniu pracy przez cudzoziemca (ZC-PZPC). Роботодавець обирає послугу за фактом, який уже настав. Копія договору, надіслана перед роботою, не замінює жодного з цих повідомлень.",
          ...
          },
          {
            ...
            example: {
              ...
              facts: [
                "Умовна польська компанія A найняла двох громадян Молдови на umowy o pracę. Обидва мали чинні національні візи для праці, що охоплювали весь розглянутий період, і не мали незалежного звільнення від дозволу. У червні 2026 року, до 29 червня, для працівника A видано звичайний дозвіл wojewody, а для працівника B зареєстровано oświadczenie. Обидва документи передбачали роботу з 1 липня до 31 грудня 2026 року.",
