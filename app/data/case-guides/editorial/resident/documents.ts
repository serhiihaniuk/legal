...
export const residentDocuments = {
  ...
  housing: {
    item: document(
      "residential-lease",
      "Чинний підписаний договір оренди житла заявника"
    ),
    level: "required",
    status: "скан до MOS, документ при явці",
    owner:
      "Заявник і орендодавець; заявник додає скан чинної оренди та пред'являє документ при особистій явці",
    proves:
      "Правову підставу користування житлом за обраною в прикладі орендою. Meldunek і повідомлена адреса не замінюють цього документа",
