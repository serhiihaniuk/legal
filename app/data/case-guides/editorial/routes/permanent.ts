...
const route: CaseGuideRoute = {
  ...
  profile: {
    ...
    description:
      "Обставини та дати вигадані. Повнолітній громадянин Білорусі має дійсну Kartę Polaka. Він переїхав до Вроцлава 01.08.2026, почав працювати за umową o pracę та винайняв житло на рік. Оренда й трудовий договір складені польською; сума винагороди та строк трудового договору в прикладі не визначені. Приклад не стосується міжнародного захисту, дитини або старого паперового провадження.",
    facts: [
      {
      ...
      },
      {
        ...
        value:
          "Чинність Karty Polaka та її належність заявнику перевірені. У заяві він пояснює намір постійно жити в Польщі. До початкового пакета 17.08 додано копію підписаної оренди, повноваження представника та підтвердження 100 zł за карту; плати 640 zł за дозвіл немає через застосовне звільнення.",
        explanation:
      ...
      },
      {
        label: "Запит органу",
        value:
          "20.08.2026 представнику вручено вимогу пояснити, чи пов'язаний переїзд лише зі строком оренди, та надати оригінал договору, чию копію вже подано. Надано 14 днів, до 03.09.2026.",
        explanation:
      ...
      },
      {
        label: "Відповідь",
        value:
          "31.08.2026 подано пояснення постійного плану, запитаний оригінал тієї самої оренди й уперше чинну umowę o pracę. Заявник прямо зазначив, що наступного договору житла ще немає.",
        explanation:
          "Прогалину в майбутньому договорі не приховали. Орган оцінює сукупність установлених обставин, а не лише фразу про намір.",
      },
    ],
    assumption:
      "Чинна карта не була анульована чи замінена; дані відповідають паспорту. Поточна робота має належну підставу. Перешкод для подання та відомих підстав відмови не встановлено. Спосіб належного подання відповіді й виконання вимоги оригіналу підтверджено окремо від UPO первинної заяви. Станом на 10.09.2026 рішення ще не вручено. Дати особистої явки, видачі довідки, карти чи повернення Karty Polaka не вигадано. Наведений пакет і своєчасна відповідь не гарантують позитивного рішення.",
  },
  choice: {
