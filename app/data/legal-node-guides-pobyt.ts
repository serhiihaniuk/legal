...
export const legalNodeGuidesPobyt: LegalNodeGuideMap = {
  "start-case": {
    introduction: [
  ...
  "goal-of-stay": {
    ...
    foreignersContext: [
      "Umowa o pracę може бути головною метою для art. 114, але не є умовою CUKR; сімейний або навчальний дозвіл може окремо впливати на доступ до праці.",
    ],
  },
  "two-keys": {
    introduction: [
  ...
  visa: {
    ...
    regulated: [
      "Art. 58–97 ustawy o cudzoziemcach регулюють польські візи, їх цілі, видачу, przedłużenie, unieważnienie та cofnięcie; правила Schengen доповнюють режим wizy C.",
    ],
    appliesWhen: [
  ...
  "pending-stay": {
    ...
    regulated: [
      "Для pobytu czasowego діє art. 108, для pobytu stałego — art. 206, для rezydenta UE — art. 222a ustawy o cudzoziemcach.",
    ],
    appliesWhen: [
  ...
  "ukraine-routes-2026": {
    introduction: [
      "У 2026 році osoba зі status UKR може залишатися в режимі ochrony czasowej, перейти на спеціальний CUKR або, у межах дозволених art. 45 ustawy z 23.01.2026 категорій, подати звичайну заяву pobytową.",
    ],
    regulated: [
      "Маршрути визначають specustawa ukraińska, ustawa Dz.U. 2026 poz. 203, art. 42c–42u та загальні норми ustawy o cudzoziemcach.",
    ],
    appliesWhen: [
  ...
  "cukr-route-2026": {
    ...
    regulated: [
      "Art. 42c–42u specustawy ukraińskiej регулюють адресатів, умови, MOS, opłaty, wydanie karty, наслідки та обов’язки після видачі.",
    ],
    appliesWhen: [
  ...
  "ukraine-ordinary-2026": {
    introduction: [
      "Art. 45 ustawy Dz.U. 2026 poz. 203 дозволяє визначеним beneficjentom ochrony czasowej подати окремі звичайні заяви pobytowe, незважаючи на загальне обмеження для ochrony czasowej.",
    ],
    regulated: [
    ...
    appliesWhen: [
      "Маршрут діє лише для категорії заяви, прямо охопленої art. 45, зокрема відповідних трудових або бізнесових підстав.",
    ],
    conditions: [
      "Заява подається через MOS і доводить кожну умову обраного дозволу; для pobyt czasowy i pracę значення мають art. 114–126 та фактичні умови праці.",
    ],
    exceptions: [
  ...
  "temporary-common": {
    ...
    regulated: [
      "Art. 98–113a ustawy o cudzoziemcach визначають загальну конструкцію, заяву, odmowę wszczęcia, odmowę, cofnięcie, właściwość та наслідки.",
    ],
    appliesWhen: [
  ...
  "stay-work": {
    ...
    regulated: [
      "Art. 114–126 регулюють позитивні умови, odmowę wszczęcia, odmowę, treść zezwolenia, зміну, втрату роботи та обов’язки.",
    ],
    appliesWhen: [
    ...
    conditions: [
      "Organ перевіряє, зокрема, umowę/Załącznik nr 1, винагороду, страхування за art. 114 ust. 1 pkt 1, реальність podmiotu та відповідність фактичної організації праці заявленій моделі.",
    ],
    exceptions: [
      "Для osoby zwolnionej z obowiązku posiadania zezwolenia na pracę treść decyzji за art. 118 може не містити всіх умов прив’язки; вирішальним є конкретне rozstrzygnięcie.",
    ],
    consequences: [
    ...
    foreignersContext: [
      "Для osoby з UKR у 2026 році доступ до цієї процедури може випливати з art. 45 ustawy Dz.U. 2026 poz. 203, але status UKR і powiadomienie pozostają окремими питаннями до надання дозволу.",
    ],
  },
  "blue-card": {
    introduction: [
    ...
    regulated: [
      "Art. 127–138 ustawy o cudzoziemcach після змін 2025–2026 визначають кваліфікації, umowę, мінімальний строк праці, wynagrodzenie, odmowy та mobilność w UE.",
    ],
    appliesWhen: [
  ...
  "business-stay": {
    ...
    regulated: [
      "Art. 142–143 визначають адресатів, економічні показники, zatrudnienie або здатність виконати ці умови в майбутньому та підстави odmowy.",
    ],
    appliesWhen: [
    ...
    procedure: [
      "Через MOS подаються заява, реєстрові, фінансові, податкові, трудові та планові докази, після чого organ оцінює виконання альтернативних умов art. 142.",
    ],
    foreignersContext: [
      "Для beneficjenta UKR доступність звичайної бізнесової процедури у 2026 році перевіряється через art. 45 ustawy Dz.U. 2026 poz. 203.",
    ],
  },
  "study-research": {
    introduction: [
    ...
    regulated: [
      "Art. 144–157f охоплюють studia, mobilność studenta, badania naukowe, mobilność naukowca, staż та пов’язані процедури.",
    ],
    appliesWhen: [
  ...
  "family-stay": {
    ...
    regulated: [
      "Art. 158–169 охоплюють małżonków, małoletnie dzieci, połączenie z cudzoziemcem або громадянином Польщі та інші сімейні ситуації.",
    ],
    appliesWhen: [
  ...
  "other-stay": {
    ...
    regulated: [
      "Art. 170–194 охоплюють, серед іншого, ofiary handlu ludźmi, okoliczności wymagające krótkotrwałego pobytu, pracę sezonową, absolwentów та інші визначені ситуації.",
    ],
    appliesWhen: [
    ...
    exceptions: [
      "Короткотривалий pobyt за art. 181 надається на необхідний строк до шести місяців і не повинен використовуватися як загальна заміна звичайної легалізації.",
    ],
    consequences: [
  ...
  "permanent-resident": {
    ...
    regulated: [
      "Art. 195–206 регулюють pobyt stały, а art. 211–222a — rezydenta długoterminowego UE; спільною є електронна процедура MOS від 27.04.2026.",
    ],
    appliesWhen: [
      "Pobyt stały застосовується за однією з підстав art. 195, rezydent UE — після належного періоду legalnego i nieprzerwanego pobytu та виконання додаткових умов.",
    ],
    conditions: [
    ...
    foreignersContext: [
      "Період CUKR офіційно зараховується до періоду для rezydenta UE, тоді як сам status UKR і періоди інших режимів потребують оцінки за art. 212.",
    ],
  },
  permanent: {
    introduction: [
      "Zezwolenie na pobyt stały надається на czas nieoznaczony особі, яка належить до однієї з точно визначених категорій art. 195.",
    ],
    regulated: [
      "Art. 195 визначає підстави, а art. 196–206 — odmowę wszczęcia, odmowę, cofnięcie, właściwość, заяву та перебування під час процедури.",
    ],
    appliesWhen: [
    ...
    exceptions: [
      "Категорії art. 195 не можна поєднувати довільно; відсутність однієї умови конкретної підстави не компенсується загальною тривалістю pobytu.",
    ],
    consequences: [
  ...
  "long-term-eu": {
    ...
    regulated: [
      "Art. 211 визначає основні умови, art. 212 — спосіб зарахування періодів і допустимі перерви, а art. 213–222a — виключення, процедуру, відмову та cofnięcie.",
    ],
    appliesWhen: [
      "Загальне правило вимагає щонайменше п’ять років legalnego i nieprzerwanego pobytu безпосередньо перед поданням.",
    ],
    conditions: [
      "Потрібні stabilne i regularne źródło dochodu, ubezpieczenie zdrowotne, підтверджена польська мова та tytuł prawny do lokalu як необхідний додаток; періоди рахуються за art. 212, а не лише календарно.",
    ],
    exceptions: [
    ...
    foreignersContext: [
      "Період studiów зазвичай зараховується наполовину, CUKR за офіційною інформацією — повністю, а періоди ochrony або очікування оцінюються за точним текстом art. 212.",
    ],
  },
}
