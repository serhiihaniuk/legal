...
const guide: DocumentGuide = {
  ...
  purpose: [
    ...
    regulationLaw.text`Дозволяє зіставити фактичну роботу з ${regulationLaw.annex("2", "Załącznikiem nr 1")}, powiadomieniem або дозволом.`,
  ],
  doesNotProve: [
  ...
  explanation: [
    {
      ...
      paragraphs: [
        "Погоджені умови можуть змінюватися aneksem. Тому для конкретної дати потрібні початковий договір і зміни, що вже набрали чинності. Не варто збирати одну «актуальну» цифру з документів, які описують різні періоди.",
      ],
      example: {
        title: "Дві суми винагороди",
        facts: [
          "Умовний приклад. У договорі зазначено одну суму, у пізнішому aneksie іншу. Виплата за місяць не збігається з жодною з них.",
        ],
        reasoning: [
          "Працівник встановив дату дії aneksu, розрахунковий період виплати та те, чи порівнює brutto з netto. Лише після цього можна з’ясувати, чи є розбіжність у погоджених умовах або тільки в способі їх відображення.",
        ],
        conclusion:
          "Для справи збережено ланцюжок договору й змін. Виплату перевіряють окремо, не прирівнюючи її автоматично до суми brutto.",
      },
    },
  ],
  legalBasis: [
