...
const guide: DocumentGuide = {
  ...
  explanation: [
    {
      id: "read-outcome",
      title: "Спочатку розв’язання справи, потім його пояснення",
      paragraphs: [
        "Відокремте rozstrzygnięcie, тобто те, що organ вирішив, від uzasadnienia, яке пояснює причини. Далі зіставте встановлені факти, оцінені докази та застосовані умови. Pouczenie прочитайте разом із даними про вручення.",
      ],
      example: {
        title: "Доказ був у пакеті, але що з ним зробив орган",
        facts: [
          "Умовний приклад. У рішенні орган вказав, що певний період не підтверджено. У копії пакета заявника є документ за цей період.",
        ],
        reasoning: [
          "Працівник перевірив подання документа, його наявність у матеріалах справи та пояснення оцінки в рішенні. Це розділило можливу відсутність матеріалу в aktach і ситуацію, коли орган його прочитав, але визнав недостатнім.",
        ],
        conclusion:
          "Подальша аргументація має відповідати встановленій проблемі. Посилання лише на назву додатка не пояснює, який висновок органу оспорюється.",
      },
    },
  ],
  legalBasis: [
