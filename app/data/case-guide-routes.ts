...
function makeStages(spec: RouteSpec): CaseGuideStage[] {
  ...
  return [
    {
      ...
      documents: [
        ...
        "реєстрові підтвердження статусу",
        "рішення та UPO з попередніх справ",
        "список виїздів",
      ],
      risks: [
        "неправильна дата факту",
        "прихована паралельна справа",
    ...
    },
    {
      ...
      documents: [
        "матриця умов",
        "актуальний текст спеціального закону",
        "факти, що відрізняють сусідні маршрути",
      ],
      risks: [
        "вибір за назвою документа",
        "ігнорування lex specialis",
        "перенесення умов з іншої підстави",
      ],
    ...
    },
    {
      ...
      documents: [
        "wniosek MOS",
        "електронний підпис",
        "фото й скани паспорта",
        "докази оплат",
        "UPO та копія вкладень",
      ],
      risks: [
        "різні дані у формі та доказах",
        "відсутній підпис або додаток",
        "паперове подання без законного винятку",
      ],
      materials: [
        mapMaterial(
          "mos-procedure",
    ...
    },
    {
      ...
      explanation: [
        "Кожна матеріальна умова отримує окремий рядок: норма, модельний факт, доказ, період і можливе протиріччя. Документ, який не доводить жодної умови, не робить пакет сильнішим; натомість один слабкий ключовий факт може визначити всю справу.",
        spec.stageFocus[3],
      ],
      ...
      documents: spec.documentItems.map((item) => item.item),
      risks: [
        "формальна повнота без матеріального доказу",
        "старий або суперечливий документ",
        "доказ іншого факту замість потрібного",
      ],
      materials: [
        mapMaterial(
          "document-matrix",
    ...
    },
    {
      ...
      documents: [
        "wezwania й докази вручення",
        "відповіді з індексом додатків",
        "копія akt sprawy",
        "підтвердження особистої явки",
      ],
      risks: [
        "змішування формальної та матеріальної вимоги",
        "відповідь без доказу подання",
        "пропущений строк або пункт wezwania",
      ],
      materials: [
        mapMaterial(
          "wezwanie-workflow",
    ...
    },
    {
      ...
      documents: [
        "decyzja з uzasadnieniem і pouczeniem",
        "доказ doręczenia",
        "підтвердження odbioru карти",
        "план обов’язків після рішення",
      ],
      risks: [
        "ототожнення карти з моментом виникнення дозволу",
        "ігнорування treści decyzji",
        "пропуск odwołania або обов’язку повідомлення",
      ],
      materials: [
        mapMaterial(
          "decision-reading",
...
function makeDocuments(spec: RouteSpec): CaseDocument[] {
  ...
  if (existing) return existing.documentRegister
...
function makeDeadlines(spec: RouteSpec): CaseDeadline[] {
  ...
  if (existing) return existing.deadlines
...
const routeSpecs: RouteSpec[] = [
  {
    ...
    title: "Karta CUKR — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Олена, громадянка України",
      description:
        "Олена має активний PESEL UKR, працює за umową o pracę і хоче довгостроково залишитися в Польщі. Її робота є важливим фактом життя, але не матеріальною умовою CUKR.",
      facts: [
    ...
    choice: {
      why: "Факти Олени можуть відповідати спеціальному CUKR, а її метою є стабільний статус без доведення матеріальних умов роботи. Тому спочатку перевіряємо спеціальні умови, а не готуємо Załącznik nr 1 як для звичайного pobytu i pracy.",
      closestAlternative:
        "Залишитися на status UKR до кінця його дії або подати доступну звичайну заяву pobytową, якщо її матеріальні умови краще відповідають цілям Олени.",
    ...
    stageFocus: [
      ...
      "Орган звіряє реєстри й умови спеціального режиму; паралельно контролюємо, що відбувається з іншими справами Олени.",
    ...
    conditions: [
      ...
      },
      {
        ...
        modelFact: "Олена заявляє UKR на 04.06.2025",
      ...
      },
      {
        ...
        modelFact: "Олена подає через MOS і з’являється особисто",
  ...
  },
  {
    ...
    title: "Pobyt czasowy i praca — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Олена, працівниця польської spółki",
      description:
        "Олена працює на pełny etat за umową o pracę. Дані договору, Załącznika nr 1 і фактичної роботи мають описувати ту саму посаду, винагороду, час і podmiot.",
      facts: [
    ...
    choice: {
      why: "Головною й реальною метою Олени є робота, тому матеріальні умови шукаємо в art. 114–126, а KPA використовуємо для процедури й доказів.",
      closestAlternative:
    ...
    conditions: [
      {
        ...
        modelFact: "Олена має тривалий договір",
      ...
      },
      {
        ...
        modelFact:
          "spółka керує Оленою й не передає її як персонал третій особі",
  ...
  },
  {
    ...
    title: "Niebieska Karta UE — повна модельна справа",
    ...
    profile: {
      name: "Марко, senior data engineer",
      description:
        "Марко має пропозицію довгострокової роботи, релевантний диплом і досвід. Потрібно довести, що саме ця посада вимагає високих кваліфікацій.",
      facts: [
    ...
    choice: {
      why: "Характер роботи й кваліфікації Марка можуть відповідати спеціальному режиму, тому не застосовуємо автоматично звичайний pobyt i pracę.",
      closestAlternative:
    ...
    conditions: [
      ...
      },
      {
        ...
        modelFact: "диплом і досвід Марка",
  ...
  },
  {
    ...
    title: "Student — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Аміна, студентка магістратури",
      description:
        "Аміна прийнята на стаціонарну магістратуру. Потрібно перевірити статус uczelni, оплату навчання, кошти, страхування й житло на потрібний період.",
      facts: [
    ...
    choice: {
      why: "Головна мета Аміни — стаціонарне навчання, а не робота. Отже, робота може бути наслідком статусу, але не підставою цього wniosku.",
      closestAlternative:
  ...
  },
  {
    ...
    title: "Działalność gospodarcza — повна модельна справа",
    ...
    profile: {
      name: "Давид, член zarządu і wspólnik",
      description:
        "Давид управляє польською spółką, яка вже має клієнтів, але її фінансові результати й зайнятість треба оцінити за законним тестом.",
      facts: [
    ...
    choice: {
      why: "Давид реально управляє бізнесом, тому перевіряємо art. 142–143, а не підміняємо діяльність звичайною посадою лише через членство в zarządzie.",
      closestAlternative:
    ...
    stageFocus: [
      "Фіксуємо всі ролі Давида: udziałowiec, zarząd, praca, reprezentacja — вони мають різні наслідки.",
    ...
    conditions: [
      {
        ...
        modelFact: "Давид управляє spółką",
  ...
  },
  {
    ...
    title: "Rodzina — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Софія, дружина cudzoziemca з pobytem",
      description:
        "Софія перебуває у документованому шлюбі й живе з чоловіком у Польщі. Потрібно точно визначити його статус і норму połączenia z rodziną.",
      facts: [
    ...
    choice: {
      why: "Реальна головна мета Софії — сімейне життя з чоловіком, тому вихідною точкою є його статус і конкретна сімейна норма.",
      closestAlternative:
        "Режим родини obywatela UE/Polski або власна незалежна підстава Софії — залежно від sponsora й фактів.",
  ...
  },
  {
    ...
    title: "Pobyt stały — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Ірина, власниця Karty Polaka",
      description:
        "Ірина планує оселитися в Польщі постійно й спирається на конкретну категорію art. 195. Її підстава не змішується з п’ятирічним тестом rezydenta UE.",
      facts: [
    ...
    choice: {
      why: "Ірина має конкретну категоріальну підставу, тому art. 195 є прямішим маршрутом, ніж рахування rezydenta UE.",
      closestAlternative:
    ...
    conditions: [
      {
        ...
        modelFact: "Ірина має Kartę Polaka",
  ...
  },
  {
    ...
    title: "Rezydent długoterminowy UE — повна модельна справа",
    subtitle:
    ...
    profile: {
      name: "Ніно, п’ятий рік у Польщі",
      description:
        "Ніно мала кілька типів pobytu, навчалася, потім працювала й виїжджала за межі Польщі. Потрібно порахувати кожен період за законом, а не скласти календарні роки.",
      facts: [
    ...
    choice: {
      why: "Ніно не має категоріальної підстави pobytu stałego, але її історія може виконувати окремий тест rezydenta UE.",
      closestAlternative:
  ...
  },
  {
    ...
    profile: {
      name: "Модельна справа до кваліфікації",
      description:
...
export const caseGuideRoutes = routeSpecs.map<CaseGuideRoute>((spec) => ({
  ...spec,
  stages: makeStages(spec),
  documents: makeDocuments(spec),
