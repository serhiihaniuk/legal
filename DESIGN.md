...
- Core routes/screens: `/`; `/law`; `/law/:documentId` (workspace redirect); `/law/:documentId/learn/:moduleId`; `/law/:documentId/provisions/:provisionId`; `/law/:documentId/practice/:practiceId`; `/guide/kpa` (compatibility); `/map`; `/map/:nodeId`; `/documents`; `/cases/:routeId`; `/study`
