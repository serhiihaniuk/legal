...
Batch 79 completes the temporary-work article in place, with the correct act for period limits and a completed agency-change comparison. The chapter now has one remaining unaccepted article, outsourcing-case. The specific KRAZ, employment-certificate, user-period and referral-confirmation document gaps are recorded in batch 79 and remain separate work.

Batch 81 completes outsourcing-case in its existing chapter. All nine employment-topic articles now have writing acceptance for their current text. This does not close the missing document destinations or whole-branch legal acceptance. Batch 82 adds the user-issued referral confirmation and the conditional reference in temporary-work. The next document gaps include the agency employment certificate, user period register and KRAZ scope; remaining map-topic dispositions stay open.

Batch 89 completes document-matrix in the evidence chapter and evidence-matrix in filing, preserving their different roles. Batch 90 completes document-types and evidence in the evidence chapter with distinct examples and specific document destinations. Case-file and foreign-documents remain the next unaccepted articles in this chapter; batch 91 records their complete-file preparation. Other pending dispositions and full source/legal acceptance remain open.

Batch 91 completes case-file and foreign-documents in the evidence chapter, preserving their distinct purposes and stable IDs. All five current evidence-chapter articles now have writing acceptance. This is scoped prose/source review, not whole-branch legal acceptance. Initiation and MOS remain next, as recorded in batch 92.

Batch 92 completes initiation and MOS in the participants-and-filing chapter with distinct paper and electronic examples. All four current articles in that chapter have writing acceptance. Five KPA-principle articles remain unaccepted map topics; batch93 prepares them in the existing hierarchy. Broader legal and source-fidelity acceptance remains open.

Batch 93 completes legality, trust and participation in the correspondence-and-proceedings chapter with source-specific mechanisms and completed examples. Only principle-two-instance and kpa-principles remain unaccepted map-topic articles. Batch94 prepares their distinct roles and current source corrections. Existing hierarchy and stable IDs remain; broader document, law-writing and source-fidelity acceptance is still open.

Batch 94 completes those two articles in their existing chapters. All 61 current map-topic files have matching writing acceptance. The overview explains principles through concrete procedural actions; two-instance review owns the comparison of administrative and judicial review and the distinct decision statuses. Stable IDs and navigation remain intact. This milestone covers authored topic articles, not every map label, document destination, legal baseline or original-source page.
