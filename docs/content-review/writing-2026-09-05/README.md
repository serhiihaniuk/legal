...
Batch 56 separates the residence chapter introductions into purpose, common procedure and permit comparison. Current writing acceptance and remaining scope are recorded in the latest checkpoint below. Earlier figures describe those checkpoints, not the present total.
...
Latest checkpoint, batch 56: 165 of 1,805 files have current writing review. The three residence introductions now have distinct questions, subject-specific sections and completed examples. The comparison leads into the existing six child branches. Cross-review corrected the universal purpose-ranking claim and a document reference. Next are detailed work, Blue Card, business and the permanent/resident parent. Remaining map articles, law modules, provision commentary, the original PDF-layout audit and independent legal review remain open. Detailed evidence is in [batch 56](batches/56-residence-introductions.md).
