...
| Every case has appropriate document coverage | For all nine guides, compare each stage and register with official requirements. Record mandatory, conditional, and working documents; verify typed links in both directions. | Work, Blue Card, student, business and family reviewed in batches 15–19; four complete routes remain pending. |
| Complex documents have useful explanations and examples | Read every document guide. Explain fields, what the document proves, what it leaves open, and a completed discrepancy example where needed. Simple documents need no artificial expansion. | All 60 guides have current writing acceptance after batch 18, including the corporate work permit. Examples include filled working records and selected fictional fragments; original-form and interface fidelity limits remain recorded in the batches. |
...
After batch 19, 98 of 1,783 inventoried files have current writing acceptance, including all 60 document guides and the complete work, Blue Card, student, business and family guides. The corpus audit must address the university and family annex page ranges, the family form's sponsor-status choices and the split words in extracted Polish text recorded in batches 09 and 13.

1. Remaining four case routes: permanent residence, long-term EU resident, CUKR and other purposes. Begin with permanent residence and the facts required by each of its distinct legal grounds.
