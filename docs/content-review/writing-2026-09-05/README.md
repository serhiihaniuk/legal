...
The resident pilot is accepted and delivered. Its stage lists name concrete documents and distinguish submission from later reuse. Batch 60 completed the employment chapter introduction. Batch 61 applies the same document-use model to the ordinary work case; batch 62 explains the three residence filing certificates.
...
Latest checkpoint, batches 61 and 62: 183 of 1,813 files have current writing review. The ordinary work case now has six open document lists with explicit actions, specific evidence and clear scans/originals timing. The filing-certificate guide covers the three statutory variants and corrects the permanent/resident destinations. Independent reviewers accepted the bounded changes. Full verification passed with 219 application tests and production build. Remaining case migrations, map and law writing, source-layout review and whole-project legal acceptance stay open. Evidence is in [batch 61](batches/61-work-case-documents.md) and [batch 62](batches/62-filing-certificate-variants.md).
