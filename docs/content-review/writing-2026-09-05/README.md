...
After batch 20, 103 of 1,787 inventoried files have current writing acceptance, including all 61 document guides and six complete case guides. The corpus audit must address the university and family annex page ranges, the family form's sponsor-status choices and the split words in extracted Polish text recorded in batches 09 and 13.
...
1. Remaining three case routes: long-term EU resident, CUKR and other purposes. Begin with the EU resident's qualifying periods, counted absences, income history and language evidence.
