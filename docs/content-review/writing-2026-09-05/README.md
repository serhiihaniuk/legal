...
| Every case has appropriate document coverage | For all nine guides, compare each stage and register with official requirements. Record mandatory, conditional, and working documents; verify typed links in both directions. | Work, Blue Card and student reviewed in batches 15–17; six complete routes remain pending. |
| Complex documents have useful explanations and examples | Read every document guide. Explain fields, what the document proves, what it leaves open, and a completed discrepancy example where needed. Simple documents need no artificial expansion. | All 59 guides have current writing acceptance after batch 17, including the notice of an ended residence purpose. Examples include filled working records and selected fictional fragments; original-form and interface fidelity limits remain recorded in the batches. |
...
After batch 17, 89 of 1,776 inventoried files have current writing acceptance, including all 59 document guides and the complete work, Blue Card and student guides. The corpus audit must address the university and family annex page ranges, the family form's sponsor-status choices and the split words in extracted Polish text recorded in batches 09 and 13.

1. Remaining six case routes, beginning with business and its distinctions between the person's role, actual activity and financial evidence.
