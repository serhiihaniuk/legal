...
1. Remaining case route: other purposes. Identify its distinct statutory categories and document requirements without presenting them as one universal permit package.
