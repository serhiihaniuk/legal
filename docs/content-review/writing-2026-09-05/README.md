...
Batch 48 rewrites person-status and begins the current-stay chapter after the five completed foundation topics. Current writing acceptance and the remaining scope are recorded in the latest checkpoint below. Earlier batch figures describe those checkpoints, not the present total.
...
Latest checkpoint, batch 48: 154 of 1,805 files have current writing review. All five orientation topics have authored explanations and completed examples. The person-status article distinguishes identity, citizenship and residence status, with a completed EU-family classification record. Next are `entry-current-basis` and the other current-stay topics. Remaining map articles, law modules, provision commentary, the original PDF-layout audit and independent legal review remain open. Detailed evidence is in [batch 48](batches/48-person-status.md).
