...
Latest checkpoint, batch 42: 147 of 1,804 files have current writing review. The opening map article now explains facts, assertions, evidence and conclusions with a filled chronology. Batches 29-41 contain the intervening map, remedy and court-document work. The next foundation topic is `legal-anatomy`, followed by `special-vs-kpa`. Remaining map articles, law modules, provision commentary, the original PDF-layout audit and independent legal review remain open. Detailed evidence is in [batch 42](batches/42-factual-description.md).
