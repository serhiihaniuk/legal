...
The resident pilot is accepted and delivered. Its stage lists name concrete documents and distinguish submission from later reuse. Batch 60 completed the employment chapter introduction. Batch 61 applies the same document-use model to the ordinary work case; batch 62 explains the three residence filing certificates. Batch 63 migrates Blue Card and adds a focused professional-experience guide.
...
| Every case has appropriate document coverage | For all nine guides, compare each stage and register with official requirements. Record mandatory, conditional, and working documents; verify typed links in both directions. | Earlier reviews covered all nine guides, but the later document-specificity audit found broad destinations and unclear repeated uses. The resident pilot resolves its main evidence groups; remaining migrations are tracked in `case-document-specificity-audit.md`. Independent legal acceptance remains separate. |
