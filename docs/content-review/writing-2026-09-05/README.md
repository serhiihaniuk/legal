...
Batch 51 rewrites pending-stay. Current writing acceptance and remaining scope are recorded in the latest checkpoint below. Earlier figures describe those checkpoints, not the present total.
...
Latest checkpoint, batch 51: 158 of 1,805 files have current writing review. All five orientation topics have authored explanations and completed examples. The person-status, entry-current-basis, visa, visa-free and pending-stay articles now explain applicable residence rules, entry, current stay, visa limits, rolling days and residence during proceedings with completed records. Next are status UKR and its connections to ordinary residence routes. Remaining map articles, law modules, provision commentary, the original PDF-layout audit and independent legal review remain open. Detailed evidence is in [batch 51](batches/51-pending-stay.md).
