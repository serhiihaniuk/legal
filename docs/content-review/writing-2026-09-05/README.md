...
Batch 37 rewrites the appeal and zażalenie articles with a completed Polish appeal and a filled comparison of two procedural refusals. Writing acceptance is 138 of 1,800 files. The remaining map dispositions, law modules, corpus layout audit and independent legal review remain pending; see `batches/37-appeal-and-complaint.md`.
...
| Complex documents have useful explanations and examples | Read every document guide. Explain fields, what the document proves, what it leaves open, and a completed discrepancy example where needed. Simple documents need no artificial expansion. | All 63 existing guides have writing acceptance after batch 36, including procedural orders. Outgoing appeal and complaint guides remain missing. Examples include filled working records and selected fictional fragments; original-form and interface fidelity limits remain recorded in the batches. |
